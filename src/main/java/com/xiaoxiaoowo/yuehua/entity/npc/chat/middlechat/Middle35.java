...
public final class Middle35 {
    public static void spawn() {
        Location location = new Location(GetEntity.world, 197, 47, 102, 180, 0);
        Villager villager = GetEntity.world.spawn(location, Villager.class, false, it -> {
            ...
            it.customName(Component.translatable("pl.npc.name.middle35"));
            ...
            buyItem.editMeta(meta -> {
                meta.displayName(Component.translatable("pl.npc.name.middle35"));
                meta.lore(List.of(
                        Component.translatable("pl.npc.chat1a.middle35"),
                        Component.translatable("pl.npc.chat1b.middle35")
                ));
            });
            ...
            sellItem.editMeta(meta -> {
                meta.displayName(Component.translatable("pl.npc.name.middle35"));
                meta.lore(List.of(
                        Component.translatable("pl.npc.chat2a.middle35"),
                        Component.translatable("pl.npc.chat2b.middle35")
                ));
            });
