...
public final class Middle65 {
    public static void spawn() {
        Location location = new Location(GetEntity.world, 185, 65, -224, 180, 0);
        Villager villager = GetEntity.world.spawn(location, Villager.class, false, it -> {
            ...
            it.customName(Component.translatable("pl.npc.name.middle65"));
            ...
            buyItem.editMeta(meta -> {
                meta.displayName(Component.translatable("pl.npc.name.middle65"));
                meta.lore(List.of(
                        Component.translatable("pl.npc.chat1a.middle65")
                ));
            });
            ...
            sellItem.editMeta(meta -> {
                meta.displayName(Component.translatable("pl.npc.name.middle65"));
                meta.lore(List.of(
                        Component.translatable("pl.npc.chat2a.middle65")
                ));
            });
