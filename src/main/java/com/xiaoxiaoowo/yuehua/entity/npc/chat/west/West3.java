...
public final class West3 {
    public static void spawn() {
        Location location = new Location(GetEntity.world, 2209, 93, -828, 0, 0);
        Villager villager = GetEntity.world.spawn(location, Villager.class, false, it -> {
            ...
            it.customName(Component.translatable("pl.npc.name.west3"));
            ...
            buyItem.editMeta(meta -> {
                meta.displayName(Component.translatable("pl.npc.name.west3"));
                meta.lore(List.of(
                        Component.translatable("pl.npc.chat1a.west3"),
                        Component.translatable("pl.npc.chat1b.west3")
                ));
            });
            ...
            sellItem.editMeta(meta -> {
                meta.displayName(Component.translatable("pl.npc.name.west3"));
                meta.lore(List.of(
                        Component.translatable("pl.npc.chat2a.west3")
                ));
            });
