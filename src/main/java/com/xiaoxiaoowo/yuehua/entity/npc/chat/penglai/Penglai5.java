...
public final class Penglai5 {
    public static void spawn() {
        Location location = new Location(GetEntity.world, 355, 33, -734, 180, 0);
        Villager villager = GetEntity.world.spawn(location, Villager.class, false, it -> {
            ...
            it.customName(Component.translatable("pl.npc.name.penglai5"));
            ...
            buyItem.editMeta(meta -> {
                meta.displayName(Component.translatable("pl.npc.name.penglai5"));
                meta.lore(List.of(Component.translatable("pl.npc.chat1a.penglai5")));
            });
            ...
            sellItem.editMeta(meta -> {
                meta.displayName(Component.translatable("pl.npc.name.penglai5"));
                meta.lore(List.of(Component.translatable("pl.npc.chat2a.penglai5"), Component.translatable("pl.npc.chat2b.penglai5")));
            });
