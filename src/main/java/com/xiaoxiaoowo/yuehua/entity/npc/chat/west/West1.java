...
public final class West1 {
    public static void spawn() {
        Location location = new Location(GetEntity.world, -184, 64, 20, 0, 0);
        Villager villager = GetEntity.world.spawn(location, Villager.class, false, it -> {
            ...
            it.customName(Component.translatable("pl.npc.name.west1"));
            it.setCustomNameVisible(true);

            List<MerchantRecipe> recipes = new ArrayList<>();

            // First trade: Lime Dye -> Lime Dye
            ItemStack buyItem = new ItemStack(Material.LIME_DYE, 1);
            buyItem.editMeta(meta -> {
                meta.displayName(Component.translatable("pl.npc.name.west1"));
                meta.lore(List.of(
                        Component.translatable("pl.npc.chat1a.west1"),
                        Component.translatable("pl.npc.chat1b.west1")
                ));
            });
            ...
            sellItem.editMeta(meta -> {
                meta.displayName(Component.translatable("pl.npc.name.west1"));
                meta.lore(List.of(
                        Component.translatable("pl.npc.chat2a.west1"),
                        Component.translatable("pl.npc.chat2b.west1")
                ));
            });
