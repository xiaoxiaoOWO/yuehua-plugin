...
public final class Middle25 {
    public static void spawn() {
        Location location = new Location(GetEntity.world, 122.5, 47, 97.5, 180, 0);
        Villager villager = GetEntity.world.spawn(location, Villager.class, false, it -> {
            ...
            it.customName(Component.translatable("pl.npc.name.middle25"));
            ...
            buyItem.editMeta(meta -> {
                meta.displayName(Component.translatable("pl.npc.name.middle25"));
                meta.lore(List.of(Component.translatable("pl.npc.chat1a.middle25")));
            });

            ItemStack sellItem = new ItemStack(Material.LIME_DYE, 1);
            sellItem.editMeta(meta -> {
                meta.displayName(Component.translatable("pl.npc.name.middle25"));
                meta.lore(List.of(Component.translatable("pl.npc.chat2a.middle25")));
            });
