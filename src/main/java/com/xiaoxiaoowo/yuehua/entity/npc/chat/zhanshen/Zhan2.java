...
public final class Zhan2 {
    public static void spawn() {
        Location location = new Location(GetEntity.world, 3270, 20, -151, 180, 0);
        Villager villager = GetEntity.world.spawn(location, Villager.class, false, it -> {
            ...
            it.setAge(100000000);
            it.customName(Component.translatable("pl.npc.name.zhan2"));
            ...
            buyItem.editMeta(meta -> {
                meta.displayName(Component.translatable("pl.npc.name.zhan2"));
                meta.lore(List.of(
                        Component.translatable("pl.npc.chat1a.zhan2"),
                        Component.translatable("pl.npc.chat1b.zhan2")
                ));
            });
            ...
            sellItem.editMeta(meta -> {
                meta.displayName(Component.translatable("pl.npc.name.zhan2"));
                meta.lore(List.of(
                        Component.translatable("pl.npc.chat2a.zhan2"),
                        Component.translatable("pl.npc.chat2b.zhan2")
                ));
            });
