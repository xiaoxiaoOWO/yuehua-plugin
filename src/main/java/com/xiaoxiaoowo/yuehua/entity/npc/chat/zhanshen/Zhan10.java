...
public final class Zhan10 {
    public static void spawn() {
        Location location = new Location(GetEntity.world, 3281, 23, -260, 0, 0);
        Villager villager = GetEntity.world.spawn(location, Villager.class, false, it -> {
            ...
            it.setAge(100000000);
            it.customName(Component.translatable("pl.npc.name.zhan10"));
            ...
            buyItem.editMeta(meta -> {
                meta.displayName(Component.translatable("pl.npc.name.zhan10"));
                meta.lore(List.of(
                        Component.translatable("pl.npc.chat1a.zhan10")
                ));
            });
            ...
            sellItem.editMeta(meta -> {
                meta.displayName(Component.translatable("pl.npc.name.zhan10"));
                meta.lore(List.of(
                        Component.translatable("pl.npc.chat2a.zhan10")
                ));
            });
