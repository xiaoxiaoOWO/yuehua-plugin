...
public final class Middle23 {
    public static void spawn() {
        Location location = new Location(GetEntity.world, 48.5, 46, 154.5, 180, 0);
        Villager villager = GetEntity.world.spawn(location, Villager.class, false, it -> {
            ...
            it.customName(Component.translatable("pl.npc.name.middle23"));
            ...
            buyItem.editMeta(meta -> {
                meta.displayName(Component.translatable("pl.npc.name.middle23"));
                meta.lore(List.of(Component.translatable("pl.npc.chat1a.middle23")));
            });

            ItemStack sellItem = new ItemStack(Material.LIME_DYE, 1);
            sellItem.editMeta(meta -> {
                meta.displayName(Component.translatable("pl.npc.name.middle23"));
                meta.lore(List.of(Component.translatable("pl.npc.chat2a.middle23")));
            });
