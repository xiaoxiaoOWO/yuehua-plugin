...
public final class Yao2 {
    public static void spawn() {
        Location location = new Location(GetEntity.world, 2822, 45, 845, 180, 0);
        Villager villager = GetEntity.world.spawn(location, Villager.class, false, it -> {
            ...
            it.setAge(100000000);
            it.customName(Component.translatable("pl.npc.name.yao2"));
            ...
            buyItem.editMeta(meta -> {
                meta.displayName(Component.translatable("pl.npc.name.yao2"));
                meta.lore(List.of(
                        Component.translatable("pl.npc.chat1a.yao2"),
                        Component.translatable("pl.npc.chat1b.yao2")
                ));
            });
            ...
            sellItem.editMeta(meta -> {
                meta.displayName(Component.translatable("pl.npc.name.yao2"));
                meta.lore(List.of(
                        Component.translatable("pl.npc.chat2a.yao2"),
                        Component.translatable("pl.npc.chat2b.yao2")
                ));
            });
