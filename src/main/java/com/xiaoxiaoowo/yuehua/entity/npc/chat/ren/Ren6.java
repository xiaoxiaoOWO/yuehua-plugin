...
public final class Ren6 {
    public static void spawn() {
        Location location = new Location(GetEntity.world, 1682, 151, 206, 0, 0);
        Villager villager = GetEntity.world.spawn(location, Villager.class, false, it -> {
            ...
            it.customName(Component.translatable("pl.npc.name.ren6"));
            ...
            buyItem.editMeta(meta -> {
                meta.displayName(Component.translatable("pl.npc.name.ren6"));
                meta.lore(List.of(
                        Component.translatable("pl.npc.chat1a.ren6")
                ));
            });
            ...
            sellItem.editMeta(meta -> {
                meta.displayName(Component.translatable("pl.npc.name.ren6"));
                meta.lore(List.of(
                        Component.translatable("pl.npc.chat2a.ren6")
                ));
            });
