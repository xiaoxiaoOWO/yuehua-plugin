...
public final class Supply1 {
    public static void spawn() {
        Location location = new Location(GetEntity.world, 2722, 41, 855, 180, 0);
        Villager villager = GetEntity.world.spawn(location, Villager.class, false, it -> {
            ...
            it.setAge(100000000);
            it.customName(Component.translatable("pl.npc.name.supply1"));
            ...
            sellItem.editMeta(meta -> {
                ...
                bookMeta.title(Component.text("§6叶灵谷补给领取说明"));
                bookMeta.author(Component.text("§9补给品管理人-胡离"));
                bookMeta.pages(List.of(Component.translatable("pl.book.supply1.page1")));
            });
