...
public final class Middle50 {
    public static void spawn() {
        Location location = new Location(GetEntity.world, 71, 48, 78, 180, 0);
        Villager villager = GetEntity.world.spawn(location, Villager.class, false, it -> {
            ...
            it.customName(Component.translatable("pl.npc.name.middle50"));
            ...
            buyItem.editMeta(meta -> {
                meta.displayName(Component.translatable("pl.npc.name.middle50"));
                meta.lore(List.of(
                        Component.translatable("pl.npc.chat1a.middle50"),
                        Component.translatable("pl.npc.chat1b.middle50")
                ));
            });
            ...
            sellItem.editMeta(meta -> {
                meta.displayName(Component.translatable("pl.npc.name.middle50"));
                meta.lore(List.of(
                        Component.translatable("pl.npc.chat2a.middle50")
                ));
            });
