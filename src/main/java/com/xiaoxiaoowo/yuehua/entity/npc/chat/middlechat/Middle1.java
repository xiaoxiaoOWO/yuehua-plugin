...
public final class Middle1 {
    public static void spawn() {
        Location location = new Location(GetEntity.world, 182.5, 47, 202.5, 180, 0);
        Villager villager = GetEntity.world.spawn(location, Villager.class, false, it -> {
            ...
            it.customName(Component.translatable("pl.npc.name.middle1"));
            ...
            buyItem.editMeta(meta -> {
                meta.displayName(Component.translatable("pl.npc.name.middle1"));
                meta.lore(List.of(Component.translatable("pl.npc.chat1a.middle1")));
            });
            ...
            sellItem.editMeta(meta -> {
                meta.displayName(Component.translatable("pl.npc.name.middle1"));
                meta.lore(List.of(
                        Component.translatable("pl.npc.chat2a.middle1"),
                        Component.translatable("pl.npc.chat2b.middle1")
                ));
            });
