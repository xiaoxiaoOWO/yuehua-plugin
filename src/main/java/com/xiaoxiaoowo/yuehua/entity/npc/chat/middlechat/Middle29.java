...
public final class Middle29 {
    public static void spawn() {
        Location location = new Location(GetEntity.world, 158, 47, 105, 180, 0);
        Villager villager = GetEntity.world.spawn(location, Villager.class, false, it -> {
            ...
            it.customName(Component.translatable("pl.npc.name.middle29"));
            ...
            buyItem.editMeta(meta -> {
                meta.displayName(Component.translatable("pl.npc.name.middle29"));
                meta.lore(List.of(
                        Component.translatable("pl.npc.chat1a.middle29")
                ));
            });
            ...
            sellItem.editMeta(meta -> {
                meta.displayName(Component.translatable("pl.npc.name.middle29"));
                meta.lore(List.of(
                        Component.translatable("pl.npc.chat2a.middle29")
                ));
            });
