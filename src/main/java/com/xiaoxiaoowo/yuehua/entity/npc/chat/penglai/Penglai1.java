...
public final class Penglai1 {
    public static void spawn() {
        Location location = new Location(GetEntity.world, 418, 35, -649, 180, 0);
        Villager villager = GetEntity.world.spawn(location, Villager.class, false, it -> {
            ...
            it.customName(Component.translatable("pl.npc.name.penglai1"));
            ...
            buyItem.editMeta(meta -> {
                meta.displayName(Component.translatable("pl.npc.name.penglai1"));
                meta.lore(List.of(Component.translatable("pl.npc.chat1a.penglai1")));
            });
            ...
            sellItem.editMeta(meta -> {
                meta.displayName(Component.translatable("pl.npc.name.penglai1"));
                meta.lore(List.of(Component.translatable("pl.npc.chat2a.penglai1")));
            });
