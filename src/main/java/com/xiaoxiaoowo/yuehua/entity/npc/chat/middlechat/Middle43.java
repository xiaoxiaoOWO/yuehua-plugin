...
public final class Middle43 {
    public static void spawn() {
        Location location = new Location(GetEntity.world, 225, 46, 78, 180, 0);
        Villager villager = GetEntity.world.spawn(location, Villager.class, false, it -> {
            ...
            it.customName(Component.translatable("pl.npc.name.middle43"));
            ...
            buyItem.editMeta(meta -> {
                meta.displayName(Component.translatable("pl.npc.name.middle43"));
                meta.lore(List.of(
                        Component.translatable("pl.npc.chat1a.middle43"),
                        Component.translatable("pl.npc.chat1b.middle43")
                ));
            });
            ...
            sellItem.editMeta(meta -> {
                meta.displayName(Component.translatable("pl.npc.name.middle43"));
                meta.lore(List.of(
                        Component.translatable("pl.npc.chat2a.middle43")
                ));
            });
