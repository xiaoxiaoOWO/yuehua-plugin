...
public final class Zhan6 {
    public static void spawn() {
        Location location = new Location(GetEntity.world, 3320, 20, -148, 0, 0);
        Villager villager = GetEntity.world.spawn(location, Villager.class, false, it -> {
            ...
            it.setAge(100000000);
            it.customName(Component.translatable("pl.npc.name.zhan6"));
            ...
            buyItem.editMeta(meta -> {
                meta.displayName(Component.translatable("pl.npc.name.zhan6"));
                meta.lore(List.of(
                        Component.translatable("pl.npc.chat1a.zhan6")
                ));
            });
            ...
            sellItem.editMeta(meta -> {
                meta.displayName(Component.translatable("pl.npc.name.zhan6"));
                meta.lore(List.of(
                        Component.translatable("pl.npc.chat2a.zhan6")
                ));
            });
