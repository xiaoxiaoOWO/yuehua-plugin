...
public final class Qiansi12 {
    public static void spawn() {
        Location location = new Location(GetEntity.world, -687, 115, 400, 0, 0);
        Villager villager = GetEntity.world.spawn(location, Villager.class, false, it -> {
            ...
            it.customName(Component.translatable("pl.npc.name.qiansi12"));
            ...
            buyItem.editMeta(meta -> {
                ...
                itemMeta.displayName(Component.translatable("pl.npc.name.qiansi12"));
                itemMeta.lore(List.of(
                        Component.translatable("pl.npc.chat1a.qiansi12")
                ));
            });
            ...
            sellItem.editMeta(meta -> {
                ...
                itemMeta.displayName(Component.translatable("pl.npc.name.qiansi12"));
                itemMeta.lore(List.of(
                        Component.translatable("pl.npc.chat2a.qiansi12")
                ));
            });
