...
public final class Middle46 {
    public static void spawn() {
        Location location = new Location(GetEntity.world, 188, 45, 48, 180, 0);
        Villager villager = GetEntity.world.spawn(location, Villager.class, false, it -> {
            ...
            it.customName(Component.translatable("pl.npc.name.middle46"));
            ...
            buyItem.editMeta(meta -> {
                meta.displayName(Component.translatable("pl.npc.name.middle46"));
                meta.lore(List.of(
                        Component.translatable("pl.npc.chat1a.middle46")
                ));
            });
            ...
            sellItem.editMeta(meta -> {
                meta.displayName(Component.translatable("pl.npc.name.middle46"));
                meta.lore(List.of(
                        Component.translatable("pl.npc.chat2a.middle46")
                ));
            });
