...
public final class Zhan7 {
    public static void spawn() {
        Location location = new Location(GetEntity.world, 3304, 20, -162, 0, 0);
        Villager villager = GetEntity.world.spawn(location, Villager.class, false, it -> {
            ...
            it.setAge(100000000);
            it.customName(Component.translatable("pl.npc.name.zhan7"));
            ...
            buyItem.editMeta(meta -> {
                meta.displayName(Component.translatable("pl.npc.name.zhan7"));
                meta.lore(List.of(
                        Component.translatable("pl.npc.chat1a.zhan7"),
                        Component.translatable("pl.npc.chat1b.zhan7")
                ));
            });
            ...
            sellItem.editMeta(meta -> {
                meta.displayName(Component.translatable("pl.npc.name.zhan7"));
                meta.lore(List.of(
                        Component.translatable("pl.npc.chat2a.zhan7")
                ));
            });
