...
public final class Penglai3 {
    public static void spawn() {
        Location location = new Location(GetEntity.world, 386, 45, -660, 180, 0);
        Villager villager = GetEntity.world.spawn(location, Villager.class, false, it -> {
            ...
            it.customName(Component.translatable("pl.npc.name.penglai3"));
            ...
            buyItem.editMeta(meta -> {
                meta.displayName(Component.translatable("pl.npc.name.penglai3"));
                meta.lore(List.of(Component.translatable("pl.npc.chat1a.penglai3")));
            });
            ...
            sellItem.editMeta(meta -> {
                meta.displayName(Component.translatable("pl.npc.name.penglai3"));
                meta.lore(List.of(Component.translatable("pl.npc.chat2a.penglai3"), Component.translatable("pl.npc.chat2b.penglai3")));
            });
