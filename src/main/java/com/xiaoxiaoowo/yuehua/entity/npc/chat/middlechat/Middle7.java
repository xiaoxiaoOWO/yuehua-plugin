...
public final class Middle7 {
    public static void spawn() {
        Location location = new Location(GetEntity.world, 155.5, 46, 185.5, 180, 0);
        Villager villager = GetEntity.world.spawn(location, Villager.class, false, it -> {
            ...
            it.customName(Component.translatable("pl.npc.name.middle7"));
            ...
            buyItem.editMeta(meta -> {
                meta.displayName(Component.translatable("pl.npc.name.middle7"));
                meta.lore(List.of(
                        Component.translatable("pl.npc.chat1a.middle7"),
                        Component.translatable("pl.npc.chat1b.middle7")
                ));
            });
            ...
            sellItem.editMeta(meta -> {
                meta.displayName(Component.translatable("pl.npc.name.middle7"));
                meta.lore(List.of(Component.translatable("pl.npc.chat2a.middle7")));
            });
