...
public final class Middle63 {
    public static void spawn() {
        Location location = new Location(GetEntity.world, 148, 65, -229, 180, 0);
        Villager villager = GetEntity.world.spawn(location, Villager.class, false, it -> {
            ...
            it.customName(Component.translatable("pl.npc.name.middle63"));
            ...
            buyItem.editMeta(meta -> {
                meta.displayName(Component.translatable("pl.npc.name.middle63"));
                meta.lore(List.of(
                        Component.translatable("pl.npc.chat1a.middle63"),
                        Component.translatable("pl.npc.chat1b.middle63")
                ));
            });
            ...
            sellItem.editMeta(meta -> {
                meta.displayName(Component.translatable("pl.npc.name.middle63"));
                meta.lore(List.of(
                        Component.translatable("pl.npc.chat2a.middle63")
                ));
            });
