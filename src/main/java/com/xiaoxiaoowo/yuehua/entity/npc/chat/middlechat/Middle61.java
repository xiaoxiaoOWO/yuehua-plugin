...
public final class Middle61 {
    public static void spawn() {
        Location location = new Location(GetEntity.world, 38, 48, 57, 180, 0);
        Villager villager = GetEntity.world.spawn(location, Villager.class, false, it -> {
            ...
            it.customName(Component.translatable("pl.npc.name.middle61"));
            ...
            buyItem.editMeta(meta -> {
                meta.displayName(Component.translatable("pl.npc.name.middle61"));
                meta.lore(List.of(
                        Component.translatable("pl.npc.chat1a.middle61")
                ));
            });
            ...
            sellItem.editMeta(meta -> {
                meta.displayName(Component.translatable("pl.npc.name.middle61"));
                meta.lore(List.of(
                        Component.translatable("pl.npc.chat2a.middle61"),
                        Component.translatable("pl.npc.chat2b.middle61")
                ));
            });
