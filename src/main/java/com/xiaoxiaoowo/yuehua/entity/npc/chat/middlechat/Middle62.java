...
public final class Middle62 {
    public static void spawn() {
        Location location = new Location(GetEntity.world, 161, 65, -229, 180, 0);
        Villager villager = GetEntity.world.spawn(location, Villager.class, false, it -> {
            ...
            it.customName(Component.translatable("pl.npc.name.middle62"));
            ...
            buyItem.editMeta(meta -> {
                meta.displayName(Component.translatable("pl.npc.name.middle62"));
                meta.lore(List.of(
                        Component.translatable("pl.npc.chat1a.middle62"),
                        Component.translatable("pl.npc.chat1b.middle62")
                ));
            });
            ...
            sellItem.editMeta(meta -> {
                meta.displayName(Component.translatable("pl.npc.name.middle62"));
                meta.lore(List.of(
                        Component.translatable("pl.npc.chat2a.middle62")
                ));
            });
