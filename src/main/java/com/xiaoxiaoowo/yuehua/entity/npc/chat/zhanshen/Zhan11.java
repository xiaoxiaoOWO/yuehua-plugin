...
public final class Zhan11 {
    public static void spawn() {
        Location location = new Location(GetEntity.world, 3280, 23, -251, 0, 0);
        Villager villager = GetEntity.world.spawn(location, Villager.class, false, it -> {
            ...
            it.setAge(100000000);
            it.customName(Component.translatable("pl.npc.name.zhan11"));
            ...
            buyItem.editMeta(meta -> {
                meta.displayName(Component.translatable("pl.npc.name.zhan11"));
                meta.lore(List.of(
                        Component.translatable("pl.npc.chat1a.zhan11"),
                        Component.translatable("pl.npc.chat1b.zhan11")
                ));
            });
            ...
            sellItem.editMeta(meta -> {
                meta.displayName(Component.translatable("pl.npc.name.zhan11"));
                meta.lore(List.of(
                        Component.translatable("pl.npc.chat2a.zhan11")
                ));
            });
