...
public final class RenTong4 {
    public static void spawn() {
        Location location = new Location(GetEntity.world, 1653.5, 153.5, 174.5, 180, 0);
        Villager villager = GetEntity.world.spawn(location, Villager.class, false, it -> {
            ...
            it.customName(Component.translatable("pl.npc.name.tong4"));
            ...
            recipe0.addIngredient(RaceProvince.ren.clone());
