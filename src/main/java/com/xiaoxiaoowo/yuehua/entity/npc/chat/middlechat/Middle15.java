...
public final class Middle15 {
    public static void spawn() {
        Location location = new Location(GetEntity.world, 122.5, 47, 155.5, 180, 0);
        Villager villager = GetEntity.world.spawn(location, Villager.class, false, it -> {
            ...
            it.customName(Component.translatable("pl.npc.name.middle15"));
            ...
            buyItem.editMeta(meta -> {
                meta.displayName(Component.translatable("pl.npc.name.middle15"));
                meta.lore(List.of(
                        Component.translatable("pl.npc.chat1a.middle15"),
                        Component.translatable("pl.npc.chat1b.middle15")
                ));
            });
            ...
            sellItem.editMeta(meta -> {
                meta.displayName(Component.translatable("pl.npc.name.middle15"));
                meta.lore(List.of(Component.translatable("pl.npc.chat2a.middle15")));
            });
