...
public final class East3 {
    public static void spawn() {
        Location location = new Location(GetEntity.world, 522, 36, 65, 180, 0);
        Villager villager = GetEntity.world.spawn(location, Villager.class, false, it -> {
            ...
            it.customName(Component.translatable("pl.npc.name.east3"));
            ...
            buyItem.editMeta(meta -> {
                meta.displayName(Component.translatable("pl.npc.name.east3"));
                meta.lore(List.of(Component.translatable("pl.npc.chat1a.east3")));
            });

            ItemStack sellItem = new ItemStack(Material.LIME_DYE, 1);
            sellItem.editMeta(meta -> {
                meta.displayName(Component.translatable("pl.npc.name.east3"));
                meta.lore(List.of(Component.translatable("pl.npc.chat2a.east3")));
            });
