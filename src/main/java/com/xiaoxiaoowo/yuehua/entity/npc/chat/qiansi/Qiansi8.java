...
public final class Qiansi8 {
    public static void spawn() {
        Location location = new Location(GetEntity.world, -845, 101, 440, 0, 0);
        Villager villager = GetEntity.world.spawn(location, Villager.class, false, it -> {
            ...
            it.customName(Component.translatable("pl.npc.name.qiansi8"));
            ...
            buyItem.editMeta(meta -> {
                ...
                itemMeta.displayName(Component.translatable("pl.npc.name.qiansi8"));
                itemMeta.lore(List.of(
                        Component.translatable("pl.npc.chat1a.qiansi8"),
                        Component.translatable("pl.npc.chat1b.qiansi8")
                ));
            });
            ...
            sellItem.editMeta(meta -> {
                ...
                itemMeta.displayName(Component.translatable("pl.npc.name.qiansi8"));
                itemMeta.lore(List.of(
                        Component.translatable("pl.npc.chat2a.qiansi8"),
                        Component.translatable("pl.npc.chat2b.qiansi8")
                ));
            });
