...
public final class Ren7 {
    public static void spawn() {
        Location location = new Location(GetEntity.world, 1756, 141, 204, 0, 0);
        Villager villager = GetEntity.world.spawn(location, Villager.class, false, it -> {
            ...
            it.customName(Component.translatable("pl.npc.name.ren7"));
            ...
            buyItem.editMeta(meta -> {
                meta.displayName(Component.translatable("pl.npc.name.ren7"));
                meta.lore(List.of(
                        Component.translatable("pl.npc.chat1a.ren7")
                ));
            });
            ...
            sellItem.editMeta(meta -> {
                meta.displayName(Component.translatable("pl.npc.name.ren7"));
                meta.lore(List.of(
                        Component.translatable("pl.npc.chat2a.ren7")
                ));
            });
