...
public final class North3 {
    public static void spawn() {
        Location location = new Location(GetEntity.world, 353, 35, -515, 0, 0); // 使用指令中的坐标
        Villager villager = GetEntity.world.spawn(location, Villager.class, false, it -> {
            ...
            it.customName(Component.translatable("pl.npc.name.north3"));
            ...
            buyItem.editMeta(meta -> {
                ...
                itemMeta.displayName(Component.translatable("pl.npc.name.north3"));
                itemMeta.lore(List.of(
                        Component.translatable("pl.npc.chat1a.north3"),
                        Component.translatable("pl.npc.chat1b.north3")
                ));
            });
            ...
            sellItem.editMeta(meta -> {
                ...
                itemMeta.displayName(Component.translatable("pl.npc.name.north3"));
                itemMeta.lore(List.of(
                        Component.translatable("pl.npc.chat2a.north3"),
                        Component.translatable("pl.npc.chat2b.north3")
                ));
            });
