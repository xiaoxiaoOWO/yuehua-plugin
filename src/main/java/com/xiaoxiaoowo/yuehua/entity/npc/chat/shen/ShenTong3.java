...
public final class ShenTong3 {
    public static void spawn() {
        Location location = new Location(GetEntity.world, 3290, 115, 359, 180, 0);
        Villager villager = GetEntity.world.spawn(location, Villager.class, false, it -> {
            ...
            it.customName(Component.translatable("pl.npc.name.shentong3"));
