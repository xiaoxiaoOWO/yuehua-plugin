...
public final class East1 {
    public static void spawn() {
        Location location = new Location(GetEntity.world, 555, 33, 7, 180, 0);
        Villager villager = GetEntity.world.spawn(location, Villager.class, false, it -> {
            ...
            it.customName(Component.translatable("pl.npc.name.east1"));
            ...
            buyItem.editMeta(meta -> {
                meta.displayName(Component.translatable("pl.npc.name.east1"));
                meta.lore(List.of(Component.translatable("pl.npc.chat1a.east1")));
            });

            ItemStack sellItem = new ItemStack(Material.LIME_DYE, 1);
            sellItem.editMeta(meta -> {
                meta.displayName(Component.translatable("pl.npc.name.east1"));
                meta.lore(List.of(Component.translatable("pl.npc.chat2a.east1")));
            });
