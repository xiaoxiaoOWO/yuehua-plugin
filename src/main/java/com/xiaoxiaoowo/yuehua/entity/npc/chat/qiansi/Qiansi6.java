...
public final class Qiansi6 {
    public static void spawn() {
        Location location = new Location(GetEntity.world, -675, 113, 411, 0, 0);
        Villager villager = GetEntity.world.spawn(location, Villager.class, false, it -> {
            ...
            it.customName(Component.translatable("pl.npc.name.qiansi6"));
            ...
            buyItem.editMeta(meta -> {
                ...
                itemMeta.displayName(Component.translatable("pl.npc.name.qiansi6"));
                itemMeta.lore(List.of(
                        Component.translatable("pl.npc.chat1a.qiansi6")
                ));
            });
            ...
            sellItem.editMeta(meta -> {
                ...
                itemMeta.displayName(Component.translatable("pl.npc.name.qiansi6"));
                itemMeta.lore(List.of(
                        Component.translatable("pl.npc.chat2a.qiansi6")
                ));
            });
