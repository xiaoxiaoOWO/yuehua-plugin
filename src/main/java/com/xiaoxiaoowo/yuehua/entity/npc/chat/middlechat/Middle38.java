...
public final class Middle38 {
    public static void spawn() {
        Location location = new Location(GetEntity.world, 270, 44, 131, 180, 0);
        Villager villager = GetEntity.world.spawn(location, Villager.class, false, it -> {
            ...
            it.customName(Component.translatable("pl.npc.name.middle38"));
            ...
            buyItem.editMeta(meta -> {
                meta.displayName(Component.translatable("pl.npc.name.middle38"));
                meta.lore(List.of(
                        Component.translatable("pl.npc.chat1a.middle38")
                ));
            });
            ...
            sellItem.editMeta(meta -> {
                meta.displayName(Component.translatable("pl.npc.name.middle38"));
                meta.lore(List.of(
                        Component.translatable("pl.npc.chat2a.middle38")
                ));
            });
