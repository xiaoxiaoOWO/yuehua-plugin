...
public final class Shen7 {
    public static void spawn() {
        Location location = new Location(GetEntity.world, 3304, 115, 376, 0, 0);
        Villager villager = GetEntity.world.spawn(location, Villager.class, false, it -> {
            ...
            it.setAge(100000000);
            it.customName(Component.translatable("pl.npc.name.shen7"));
            ...
            buyMeta.displayName(Component.translatable("pl.npc.name.shen7"));
            buyMeta.lore(List.of(
                    Component.translatable("pl.npc.chat1a.shen7"),
                    Component.translatable("pl.npc.chat1b.shen7")
            ));
            ...
            sellMeta.displayName(Component.translatable("pl.npc.name.shen7"));
            sellMeta.lore(List.of(
                    Component.translatable("pl.npc.chat2a.shen7"),
                    Component.translatable("pl.npc.chat2b.shen7")
            ));
