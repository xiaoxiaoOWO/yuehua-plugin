...
public final class Qiansi3 {
    public static void spawn() {
        Location location = new Location(GetEntity.world, -633, 114, 424, 0, 0);
        Villager villager = GetEntity.world.spawn(location, Villager.class, false, it -> {
            ...
            it.customName(Component.translatable("pl.npc.name.qiansi3"));
            ...
            buyItem.editMeta(meta -> {
                ...
                itemMeta.displayName(Component.translatable("pl.npc.name.qiansi3"));
                itemMeta.lore(List.of(
                        Component.translatable("pl.npc.chat1a.qiansi3")
                ));
            });
            ...
            sellItem.editMeta(meta -> {
                ...
                itemMeta.displayName(Component.translatable("pl.npc.name.qiansi3"));
                itemMeta.lore(List.of(
                        Component.translatable("pl.npc.chat2a.qiansi3")
                ));
            });
