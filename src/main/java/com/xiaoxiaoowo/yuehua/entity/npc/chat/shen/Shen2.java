...
public final class Shen2 {
    public static void spawn() {
        Location location = new Location(GetEntity.world, 3344, 156, 152, 0, 0);
        Villager villager = GetEntity.world.spawn(location, Villager.class, false, it -> {
            ...
            it.setAge(100000000);
            it.customName(Component.translatable("pl.npc.name.shen2"));
            ...
            buyItem.editMeta(meta -> {
                meta.displayName(Component.translatable("pl.npc.name.shen2"));
                meta.lore(List.of(Component.translatable("pl.npc.chat1a.shen2")));
            });
            ...
            sellItem.editMeta(meta -> {
                meta.displayName(Component.translatable("pl.npc.name.shen2"));
                meta.lore(List.of(Component.translatable("pl.npc.chat2a.shen2")));
            });
