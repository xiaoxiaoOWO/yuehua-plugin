...
public final class Shen8 {
    public static void spawn() {
        Location location = new Location(GetEntity.world, 3231, 100, 273, 0, 0);
        Villager villager = GetEntity.world.spawn(location, Villager.class, false, it -> {
            ...
            it.setAge(100000000);
            it.customName(Component.translatable("pl.npc.name.shen8"));
            ...
            buyMeta.displayName(Component.translatable("pl.npc.name.shen8"));
            buyMeta.lore(List.of(Component.translatable("pl.npc.chat1a.shen8")));
            buyItem.setItemMeta(buyMeta);

            // Sell item
            ItemStack sellItem = new ItemStack(Material.LIME_DYE, 1);
            ItemMeta sellMeta = sellItem.getItemMeta();
            sellMeta.displayName(Component.translatable("pl.npc.name.shen8"));
            sellMeta.lore(List.of(Component.translatable("pl.npc.chat2a.shen8")));
