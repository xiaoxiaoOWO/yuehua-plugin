...
public final class Middle58 {
    public static void spawn() {
        Location location = new Location(GetEntity.world, 54, 47, 107, 180, 0);
        Villager villager = GetEntity.world.spawn(location, Villager.class, false, it -> {
            ...
            it.customName(Component.translatable("pl.npc.name.middle58"));
            ...
            buyItem.editMeta(meta -> {
                meta.displayName(Component.translatable("pl.npc.name.middle58"));
                meta.lore(List.of(
                        Component.translatable("pl.npc.chat1a.middle58")
                ));
            });
            ...
            sellItem.editMeta(meta -> {
                meta.displayName(Component.translatable("pl.npc.name.middle58"));
                meta.lore(List.of(
                        Component.translatable("pl.npc.chat2a.middle58")
                ));
            });
