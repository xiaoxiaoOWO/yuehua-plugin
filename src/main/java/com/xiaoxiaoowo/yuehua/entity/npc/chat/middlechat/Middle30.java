...
public final class Middle30 {
    public static void spawn() {
        Location location = new Location(GetEntity.world, 151, 47, 95, 180, 0);
        Villager villager = GetEntity.world.spawn(location, Villager.class, false, it -> {
            ...
            it.customName(Component.translatable("pl.npc.name.middle30"));
            ...
            buyItem.editMeta(meta -> {
                meta.displayName(Component.translatable("pl.npc.name.middle30"));
                meta.lore(List.of(
                        Component.translatable("pl.npc.chat1a.middle30")
                ));
            });
            ...
            sellItem.editMeta(meta -> {
                meta.displayName(Component.translatable("pl.npc.name.middle30"));
                meta.lore(List.of(
                        Component.translatable("pl.npc.chat2a.middle30")
                ));
            });
