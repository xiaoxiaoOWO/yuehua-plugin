...
public final class Qiansi10 {
    public static void spawn() {
        Location location = new Location(GetEntity.world, -795, 102, 430, 0, 0);
        Villager villager = GetEntity.world.spawn(location, Villager.class, false, it -> {
            ...
            it.customName(Component.translatable("pl.npc.name.qiansi10"));
            ...
            buyItem.editMeta(meta -> {
                ...
                itemMeta.displayName(Component.translatable("pl.npc.name.qiansi10"));
                itemMeta.lore(List.of(
                        Component.translatable("pl.npc.chat1a.qiansi10"),
                        Component.translatable("pl.npc.chat1b.qiansi10")
                ));
            });
            ...
            sellItem.editMeta(meta -> {
                ...
                itemMeta.displayName(Component.translatable("pl.npc.name.qiansi10"));
                itemMeta.lore(List.of(
                        Component.translatable("pl.npc.chat2a.qiansi10"),
                        Component.translatable("pl.npc.chat2b.qiansi10")
                ));
            });
