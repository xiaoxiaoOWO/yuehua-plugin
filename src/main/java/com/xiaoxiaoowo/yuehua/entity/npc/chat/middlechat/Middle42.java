...
public final class Middle42 {
    public static void spawn() {
        Location location = new Location(GetEntity.world, 287, 44, 102, 180, 0);
        Villager villager = GetEntity.world.spawn(location, Villager.class, false, it -> {
            ...
            it.customName(Component.translatable("pl.npc.name.middle42"));
            ...
            buyItem.editMeta(meta -> {
                meta.displayName(Component.translatable("pl.npc.name.middle42"));
                meta.lore(List.of(
                        Component.translatable("pl.npc.chat1a.middle42")
                ));
            });
            ...
            sellItem.editMeta(meta -> {
                meta.displayName(Component.translatable("pl.npc.name.middle42"));
                meta.lore(List.of(
                        Component.translatable("pl.npc.chat2a.middle42")
                ));
            });
