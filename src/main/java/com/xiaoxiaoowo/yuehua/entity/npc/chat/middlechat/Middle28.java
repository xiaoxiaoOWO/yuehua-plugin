...
public final class Middle28 {
    public static void spawn() {
        Location location = new Location(GetEntity.world, 150, 48, 129, 180, 0);
        Villager villager = GetEntity.world.spawn(location, Villager.class, false, it -> {
            ...
            it.customName(Component.translatable("pl.npc.name.middle28"));
            ...
            buyItem.editMeta(meta -> {
                meta.displayName(Component.translatable("pl.npc.name.middle28"));
                meta.lore(List.of(
                        Component.translatable("pl.npc.chat1a.middle28"),
                        Component.translatable("pl.npc.chat1b.middle28")
                ));
            });
            ...
            sellItem.editMeta(meta -> {
                meta.displayName(Component.translatable("pl.npc.name.middle28"));
                meta.lore(List.of(
                        Component.translatable("pl.npc.chat2a.middle28"),
                        Component.translatable("pl.npc.chat2b.middle28")
                ));
            });
