...
public final class Yao6 {
    public static void spawn() {
        Location location = new Location(GetEntity.world, 2730, 75, 873, 180, 0);
        Villager villager = GetEntity.world.spawn(location, Villager.class, false, it -> {
            ...
            it.setAge(100000000);
            it.customName(Component.translatable("pl.npc.name.yao6"));
            ...
            buyItem.editMeta(meta -> {
                meta.displayName(Component.translatable("pl.npc.name.yao6"));
                meta.lore(List.of(
                        Component.translatable("pl.npc.chat1a.yao6"),
                        Component.translatable("pl.npc.chat1b.yao6")
                ));
            });
            ...
            sellItem.editMeta(meta -> {
                meta.displayName(Component.translatable("pl.npc.name.yao6"));
                meta.lore(List.of(
                        Component.translatable("pl.npc.chat2a.yao6"),
                        Component.translatable("pl.npc.chat2b.yao6")
                ));
            });
