...
public final class Middle54 {
    public static void spawn() {
        Location location = new Location(GetEntity.world, 71, 47, -8, 180, 0);
        Villager villager = GetEntity.world.spawn(location, Villager.class, false, it -> {
            ...
            it.customName(Component.translatable("pl.npc.name.middle54"));
            ...
            buyItem.editMeta(meta -> {
                meta.displayName(Component.translatable("pl.npc.name.middle54"));
                meta.lore(List.of(
                        Component.translatable("pl.npc.chat1a.middle54"),
                        Component.translatable("pl.npc.chat1b.middle54")
                ));
            });
            ...
            sellItem.editMeta(meta -> {
                meta.displayName(Component.translatable("pl.npc.name.middle54"));
                meta.lore(List.of(
                        Component.translatable("pl.npc.chat2a.middle54")
                ));
            });
