...
public final class Middle68 {
    public static void spawn() {
        Location location = new Location(GetEntity.world, 176, 65, -219, 180, 0);
        Villager villager = GetEntity.world.spawn(location, Villager.class, false, it -> {
            ...
            it.customName(Component.translatable("pl.npc.name.middle68"));
            ...
            buyItem.editMeta(meta -> {
                meta.displayName(Component.translatable("pl.npc.name.middle68"));
                meta.lore(List.of(
                        Component.translatable("pl.npc.chat1a.middle68")
                ));
            });
            ...
            sellItem.editMeta(meta -> {
                meta.displayName(Component.translatable("pl.npc.name.middle68"));
                meta.lore(List.of(
                        Component.translatable("pl.npc.chat2a.middle68"),
                        Component.translatable("pl.npc.chat2b.middle68")
                ));
            });
