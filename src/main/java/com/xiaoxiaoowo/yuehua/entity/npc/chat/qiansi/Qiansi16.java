...
public final class Qiansi16 {
    public static void spawn() {
        Location location = new Location(GetEntity.world, -848, 192, 480, 0, 0);
        Villager villager = GetEntity.world.spawn(location, Villager.class, false, it -> {
            ...
            it.customName(Component.translatable("pl.npc.name.qiansi16"));
            ...
            buyItem1.editMeta(meta -> {
                ...
                itemMeta.displayName(Component.translatable("pl.npc.name.qiansi16"));
                itemMeta.lore(List.of(
                        Component.translatable("pl.npc.chat1a.qiansi16"),
                        Component.translatable("pl.npc.chat1b.qiansi16")
                ));
            });
            ...
            sellItem1.editMeta(meta -> {
                ...
                itemMeta.displayName(Component.translatable("pl.npc.name.qiansi16"));
                itemMeta.lore(List.of(
                        Component.translatable("pl.npc.chat2a.qiansi16"),
                        Component.translatable("pl.npc.chat2b.qiansi16")
                ));
            });
