...
public final class Tong20 {
    public static void spawn() {
        Location location = new Location(GetEntity.world, 2749, 44, 869, 180, 0);
        Villager villager = GetEntity.world.spawn(location, Villager.class, false, it -> {
            ...
            it.setAge(100000000);
            it.customName(Component.translatable("pl.npc.name.tong20"));
            ...
            buyItem1.editMeta(meta -> {
                meta.displayName(Component.translatable("pl.npc.name.tong20"));
                meta.lore(List.of(
                        Component.translatable("pl.npc.chat1a.tong20"),
                        Component.translatable("pl.npc.chat1b.tong20")
                ));
            });
            ...
            sellItem1.editMeta(meta -> {
                meta.displayName(Component.translatable("pl.npc.name.tong20"));
                meta.lore(List.of(
                        Component.translatable("pl.npc.chat2a.tong20"),
                        Component.translatable("pl.npc.chat2b.tong20")
                ));
            });
