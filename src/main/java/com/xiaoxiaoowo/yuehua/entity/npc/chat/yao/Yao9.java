...
public final class Yao9 {
    public static void spawn() {
        Location location = new Location(GetEntity.world, 2768, 54, 833, 180, 0);
        Villager villager = GetEntity.world.spawn(location, Villager.class, false, it -> {
            ...
            it.setAge(100000000);
            it.customName(Component.translatable("pl.npc.name.yao9"));
            ...
            buyItem.editMeta(meta -> {
                meta.displayName(Component.translatable("pl.npc.name.yao9"));
                meta.lore(List.of(
                        Component.translatable("pl.npc.chat1a.yao9"),
                        Component.translatable("pl.npc.chat1b.yao9")
                ));
            });
            ...
            sellItem.editMeta(meta -> {
                meta.displayName(Component.translatable("pl.npc.name.yao9"));
                meta.lore(List.of(
                        Component.translatable("pl.npc.chat2a.yao9"),
                        Component.translatable("pl.npc.chat2b.yao9")
                ));
            });
