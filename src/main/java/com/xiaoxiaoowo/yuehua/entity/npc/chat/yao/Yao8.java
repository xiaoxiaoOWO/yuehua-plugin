...
public final class Yao8 {
    public static void spawn() {
        Location location = new Location(GetEntity.world, 2777, 52, 872, 180, 0);
        Villager villager = GetEntity.world.spawn(location, Villager.class, false, it -> {
            ...
            it.setAge(100000000);
            it.customName(Component.translatable("pl.npc.name.yao8"));
            ...
            buyItem.editMeta(meta -> {
                meta.displayName(Component.translatable("pl.npc.name.yao8"));
                meta.lore(List.of(
                        Component.translatable("pl.npc.chat1a.yao8")
                ));
            });
            ...
            sellItem.editMeta(meta -> {
                meta.displayName(Component.translatable("pl.npc.name.yao8"));
                meta.lore(List.of(
                        Component.translatable("pl.npc.chat2a.yao8")
                ));
            });
