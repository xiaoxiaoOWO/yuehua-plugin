...
public final class Qiansi15 {
    public static void spawn() {
        Location location = new Location(GetEntity.world, -785, 143, 560, 0, 0);
        Villager villager = GetEntity.world.spawn(location, Villager.class, false, it -> {
            ...
            it.customName(Component.translatable("pl.npc.name.qiansi15"));
            ...
            buyItem.editMeta(meta -> {
                ...
                itemMeta.displayName(Component.translatable("pl.npc.name.qiansi15"));
                itemMeta.lore(List.of(
                        Component.translatable("pl.npc.chat1a.qiansi15"),
                        Component.translatable("pl.npc.chat1b.qiansi15")
                ));
            });
            ...
            sellItem.editMeta(meta -> {
                ...
                itemMeta.displayName(Component.translatable("pl.npc.name.qiansi15"));
                itemMeta.lore(List.of(
                        Component.translatable("pl.npc.chat2a.qiansi15"),
                        Component.translatable("pl.npc.chat2b.qiansi15")
                ));
            });
