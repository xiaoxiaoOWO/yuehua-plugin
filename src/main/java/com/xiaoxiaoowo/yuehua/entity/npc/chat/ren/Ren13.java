...
public final class Ren13 {
    public static void spawn() {
        Location location = new Location(GetEntity.world, 1657, 147, 131, 0, 0);
        Villager villager = GetEntity.world.spawn(location, Villager.class, false, it -> {
            ...
            it.customName(Component.translatable("pl.npc.name.ren13"));
            ...
            buyItem.editMeta(meta -> {
                meta.displayName(Component.translatable("pl.npc.name.ren13"));
                meta.lore(List.of(
                        Component.translatable("pl.npc.chat1a.ren13"),
                        Component.translatable("pl.npc.chat1b.ren13")
                ));
            });
            ...
            sellItem.editMeta(meta -> {
                meta.displayName(Component.translatable("pl.npc.name.ren13"));
                meta.lore(List.of(
                        Component.translatable("pl.npc.chat2a.ren13"),
                        Component.translatable("pl.npc.chat2b.ren13")
                ));
            });
