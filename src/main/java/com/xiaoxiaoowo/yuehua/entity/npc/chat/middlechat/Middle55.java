...
public final class Middle55 {
    public static void spawn() {
        Location location = new Location(GetEntity.world, 304, 44, 59, 180, 0);
        Villager villager = GetEntity.world.spawn(location, Villager.class, false, it -> {
            ...
            it.customName(Component.translatable("pl.npc.name.middle55"));
            ...
            buyItem.editMeta(meta -> {
                meta.displayName(Component.translatable("pl.npc.name.middle55"));
                meta.lore(List.of(
                        Component.translatable("pl.npc.chat1a.middle55")
                ));
            });
            ...
            sellItem.editMeta(meta -> {
                meta.displayName(Component.translatable("pl.npc.name.middle55"));
                meta.lore(List.of(
                        Component.translatable("pl.npc.chat2a.middle55")
                ));
            });
