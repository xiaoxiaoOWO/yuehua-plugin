...
public final class Zhan1 {
    public static void spawn() {
        Location location = new Location(GetEntity.world, 3265, 20, -151, 180, 0);
        Villager villager = GetEntity.world.spawn(location, Villager.class, false, it -> {
            ...
            it.setAge(100000000);
            it.customName(Component.translatable("pl.npc.name.zhan1"));
            ...
            buyItem.editMeta(meta -> {
                meta.displayName(Component.translatable("pl.npc.name.zhan1"));
                meta.lore(List.of(
                        Component.translatable("pl.npc.chat1a.zhan1"),
                        Component.translatable("pl.npc.chat1b.zhan1")
                ));
            });
            ...
            sellItem.editMeta(meta -> {
                meta.displayName(Component.translatable("pl.npc.name.zhan1"));
                meta.lore(List.of(
                        Component.translatable("pl.npc.chat2a.zhan1"),
                        Component.translatable("pl.npc.chat2b.zhan1")
                ));
            });
