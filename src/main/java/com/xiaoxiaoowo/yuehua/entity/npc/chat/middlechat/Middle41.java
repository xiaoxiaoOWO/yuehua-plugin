...
public final class Middle41 {
    public static void spawn() {
        Location location = new Location(GetEntity.world, 279, 44, 118, 180, 0);
        Villager villager = GetEntity.world.spawn(location, Villager.class, false, it -> {
            ...
            it.customName(Component.translatable("pl.npc.name.middle41"));
            ...
            buyItem.editMeta(meta -> {
                meta.displayName(Component.translatable("pl.npc.name.middle41"));
                meta.lore(List.of(
                        Component.translatable("pl.npc.chat1a.middle41")
                ));
            });
            ...
            sellItem.editMeta(meta -> {
                meta.displayName(Component.translatable("pl.npc.name.middle41"));
                meta.lore(List.of(
                        Component.translatable("pl.npc.chat2a.middle41"),
                        Component.translatable("pl.npc.chat2b.middle41")
                ));
            });
