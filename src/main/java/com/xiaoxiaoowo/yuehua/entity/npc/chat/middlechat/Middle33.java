...
public final class Middle33 {
    public static void spawn() {
        Location location = new Location(GetEntity.world, 195, 47, 107, 180, 0);
        Villager villager = GetEntity.world.spawn(location, Villager.class, false, it -> {
            ...
            it.customName(Component.translatable("pl.npc.name.middle33"));
            ...
            buyItem.editMeta(meta -> {
                meta.displayName(Component.translatable("pl.npc.name.middle33"));
                meta.lore(List.of(
                        Component.translatable("pl.npc.chat1a.middle33"),
                        Component.translatable("pl.npc.chat1b.middle33")
                ));
            });
            ...
            sellItem.editMeta(meta -> {
                meta.displayName(Component.translatable("pl.npc.name.middle33"));
                meta.lore(List.of(
                        Component.translatable("pl.npc.chat2a.middle33")
                ));
            });
