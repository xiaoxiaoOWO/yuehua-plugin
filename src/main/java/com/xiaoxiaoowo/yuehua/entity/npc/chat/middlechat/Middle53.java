...
public final class Middle53 {
    public static void spawn() {
        Location location = new Location(GetEntity.world, 59, 48, 34, 180, 0);
        Villager villager = GetEntity.world.spawn(location, Villager.class, false, it -> {
            ...
            it.customName(Component.translatable("pl.npc.name.middle53"));
            ...
            buyItem.editMeta(meta -> {
                meta.displayName(Component.translatable("pl.npc.name.middle53"));
                meta.lore(List.of(
                        Component.translatable("pl.npc.chat1a.middle53"),
                        Component.translatable("pl.npc.chat1b.middle53")
                ));
            });
            ...
            sellItem.editMeta(meta -> {
                meta.displayName(Component.translatable("pl.npc.name.middle53"));
                meta.lore(List.of(
                        Component.translatable("pl.npc.chat2a.middle53"),
                        Component.translatable("pl.npc.chat2b.middle53")
                ));
            });
