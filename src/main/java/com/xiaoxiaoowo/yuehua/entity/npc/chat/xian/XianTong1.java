...
public final class XianTong1 {
    public static void spawn() {
        Location location = new Location(GetEntity.world, 3236.5, 67, 885.5, -180, 0);
        Villager villager = GetEntity.world.spawn(location, Villager.class, false, it -> {
            ...
            it.customName(Component.translatable("pl.npc.name.xiantong1"));
