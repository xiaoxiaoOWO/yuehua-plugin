...
public final class Middle39 {
    public static void spawn() {
        Location location = new Location(GetEntity.world, 284, 44, 140, 180, 0);
        Villager villager = GetEntity.world.spawn(location, Villager.class, false, it -> {
            ...
            it.customName(Component.translatable("pl.npc.name.middle39"));
            ...
            buyItem.editMeta(meta -> {
                meta.displayName(Component.translatable("pl.npc.name.middle39"));
                meta.lore(List.of(
                        Component.translatable("pl.npc.chat1a.middle39"),
                        Component.translatable("pl.npc.chat1b.middle39")
                ));
            });
            ...
            sellItem.editMeta(meta -> {
                meta.displayName(Component.translatable("pl.npc.name.middle39"));
                meta.lore(List.of(
                        Component.translatable("pl.npc.chat2a.middle39"),
                        Component.translatable("pl.npc.chat2b.middle39")
                ));
            });
