...
public final class Yao3 {
    public static void spawn() {
        Location location = new Location(GetEntity.world, 2736, 44, 849, 180, 0);
        Villager villager = GetEntity.world.spawn(location, Villager.class, false, it -> {
            ...
            it.setAge(100000000);
            it.customName(Component.translatable("pl.npc.name.yao3"));
            ...
            buyItem.editMeta(meta -> {
                meta.displayName(Component.translatable("pl.npc.name.yao3"));
                meta.lore(List.of(
                        Component.translatable("pl.npc.chat1a.yao3"),
                        Component.translatable("pl.npc.chat1b.yao3")
                ));
            });
            ...
            sellItem.editMeta(meta -> {
                meta.displayName(Component.translatable("pl.npc.name.yao3"));
                meta.lore(List.of(
                        Component.translatable("pl.npc.chat2a.yao3")
                ));
            });
