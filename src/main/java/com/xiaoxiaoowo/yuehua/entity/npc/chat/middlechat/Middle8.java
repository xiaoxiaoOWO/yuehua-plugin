...
public final class Middle8 {
    public static void spawn() {
        Location location = new Location(GetEntity.world, 130.5, 46, 189.5, 180, 0);
        Villager villager = GetEntity.world.spawn(location, Villager.class, false, it -> {
            ...
            it.customName(Component.translatable("pl.npc.name.middle8"));
            ...
            buyItem.editMeta(meta -> {
                meta.displayName(Component.translatable("pl.npc.name.middle8"));
                meta.lore(List.of(
                        Component.translatable("pl.npc.chat1a.middle8"),
                        Component.translatable("pl.npc.chat1b.middle8")
                ));
            });
            ...
            sellItem.editMeta(meta -> {
                meta.displayName(Component.translatable("pl.npc.name.middle8"));
                meta.lore(List.of(
                        Component.translatable("pl.npc.chat2a.middle8"),
                        Component.translatable("pl.npc.chat2b.middle8")
                ));
            });
