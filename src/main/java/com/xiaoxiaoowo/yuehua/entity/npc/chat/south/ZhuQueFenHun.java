...
public final class ZhuQueFenHun {
    public static void spawn() {
        Location location = new Location(GetEntity.world, 3215, 148, -798, 180, 0);
        Villager villager = GetEntity.world.spawn(location, Villager.class, false, it -> {
            ...
            it.customName(Component.translatable("pl.npc.name.southm4"));
            ...
            sellItem.editMeta(meta -> {
                ...
                bookMeta.title(Component.text("§9朱雀的试炼"));
                bookMeta.author(Component.text("§9朱雀分魂"));
                bookMeta.pages(List.of(
                        Component.translatable("pl.book.southm7.page1")
                ));
            });
