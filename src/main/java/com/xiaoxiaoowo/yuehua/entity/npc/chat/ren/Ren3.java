...
public final class Ren3 {
    public static void spawn() {
        Location location = new Location(GetEntity.world, 1693, 157, 166, 0, 0);
        Villager villager = GetEntity.world.spawn(location, Villager.class, false, it -> {
            ...
            it.customName(Component.translatable("pl.npc.name.ren3"));
            ...
            buyItem.editMeta(meta -> {
                meta.displayName(Component.translatable("pl.npc.name.ren3"));
                meta.lore(List.of(
                        Component.translatable("pl.npc.chat1a.ren3")
                ));
            });
            ...
            sellItem.editMeta(meta -> {
                meta.displayName(Component.translatable("pl.npc.name.ren3"));
                meta.lore(List.of(
                        Component.translatable("pl.npc.chat2a.ren3")
                ));
            });
