...
public final class Ren5 {
    public static void spawn() {
        Location location = new Location(GetEntity.world, 1620, 154, 151, 0, 0);
        Villager villager = GetEntity.world.spawn(location, Villager.class, false, it -> {
            ...
            it.customName(Component.translatable("pl.npc.name.ren5"));
            ...
            buyItem.editMeta(meta -> {
                meta.displayName(Component.translatable("pl.npc.name.ren5"));
                meta.lore(List.of(
                        Component.translatable("pl.npc.chat1a.ren5")
                ));
            });
            ...
            sellItem.editMeta(meta -> {
                meta.displayName(Component.translatable("pl.npc.name.ren5"));
                meta.lore(List.of(
                        Component.translatable("pl.npc.chat2a.ren5")
                ));
            });
