...
public final class ShenTong2 {
    public static void spawn() {
        Location location = new Location(GetEntity.world, 3290, 115, 360, 180, 0);
        Villager villager = GetEntity.world.spawn(location, Villager.class, false, it -> {
            ...
            it.customName(Component.translatable("pl.npc.name.shentong2"));
