...
public final class Middle27 {
    public static void spawn() {
        Location location = new Location(GetEntity.world, 136, 47, 120, 180, 0);
        Villager villager = GetEntity.world.spawn(location, Villager.class, false, it -> {
            ...
            it.customName(Component.translatable("pl.npc.name.middle27"));
            ...
            buyItem.editMeta(meta -> {
                meta.displayName(Component.translatable("pl.npc.name.middle27"));
                meta.lore(List.of(
                        Component.translatable("pl.npc.chat1a.middle27")
                ));
            });
            ...
            sellItem.editMeta(meta -> {
                meta.displayName(Component.translatable("pl.npc.name.middle27"));
                meta.lore(List.of(
                        Component.translatable("pl.npc.chat2a.middle27"),
                        Component.translatable("pl.npc.chat2b.middle27")
                ));
            });
