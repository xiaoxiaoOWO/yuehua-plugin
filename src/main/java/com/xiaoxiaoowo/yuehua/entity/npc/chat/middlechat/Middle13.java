...
public final class Middle13 {
    public static void spawn() {
        Location location = new Location(GetEntity.world, 145.5, 48, 159.5, 180, 0);
        Villager villager = GetEntity.world.spawn(location, Villager.class, false, it -> {
            ...
            it.customName(Component.translatable("pl.npc.name.middle13"));
            ...
            buyItem.editMeta(meta -> {
                meta.displayName(Component.translatable("pl.npc.name.middle13"));
                meta.lore(List.of(
                        Component.translatable("pl.npc.chat1a.middle13"),
                        Component.translatable("pl.npc.chat1b.middle13")
                ));
            });
            ...
            sellItem.editMeta(meta -> {
                meta.displayName(Component.translatable("pl.npc.name.middle13"));
                meta.lore(List.of(
                        Component.translatable("pl.npc.chat2a.middle13"),
                        Component.translatable("pl.npc.chat2b.middle13")
                ));
            });
