...
public final class South1 {
    public static void spawn() {
        Location location = new Location(GetEntity.world, -321, 58, 596, 180, 0);
        Villager villager = GetEntity.world.spawn(location, Villager.class, false, it -> {
            ...
            it.customName(Component.translatable("pl.npc.name.south1"));
            ...
            buyItem.editMeta(meta -> {
                meta.displayName(Component.translatable("pl.npc.name.south1"));
                meta.lore(List.of(Component.translatable("pl.npc.chat1a.south1")));
            });
            ...
            sellItem.editMeta(meta -> {
                meta.displayName(Component.translatable("pl.npc.name.south1"));
                meta.lore(List.of(
                        Component.translatable("pl.npc.chat2a.south1"),
                        Component.translatable("pl.npc.chat2b.south1")
                ));
            });
