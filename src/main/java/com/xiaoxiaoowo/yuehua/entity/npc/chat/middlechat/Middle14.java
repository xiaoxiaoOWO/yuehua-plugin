...
public final class Middle14 {
    public static void spawn() {
        Location location = new Location(GetEntity.world, 146.5, 46, 150.5, 180, 0);
        Villager villager = GetEntity.world.spawn(location, Villager.class, false, it -> {
            ...
            it.customName(Component.translatable("pl.npc.name.middle14"));
            ...
            buyItem.editMeta(meta -> {
                meta.displayName(Component.translatable("pl.npc.name.middle14"));
                meta.lore(List.of(
                        Component.translatable("pl.npc.chat1a.middle14"),
                        Component.translatable("pl.npc.chat1b.middle14")
                ));
            });
            ...
            sellItem.editMeta(meta -> {
                meta.displayName(Component.translatable("pl.npc.name.middle14"));
                meta.lore(List.of(
                        Component.translatable("pl.npc.chat2a.middle14"),
                        Component.translatable("pl.npc.chat2b.middle14")
                ));
            });
