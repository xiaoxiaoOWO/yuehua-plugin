...
public final class Supply3 {
    public static void spawn() {
        Location location = new Location(GetEntity.world, 3272, 20, -153, 0, 0);
        Villager villager = GetEntity.world.spawn(location, Villager.class, false, it -> {
            ...
            it.setAge(100000000);
            it.customName(Component.translatable("pl.npc.name.supply3"));
            ...
            sellItem.editMeta(meta -> {
                ...
                bookMeta.title(Component.text("§6战备补给领取说明"));
                bookMeta.author(Component.text("§9补给品管理人-何声量"));
                bookMeta.pages(List.of(
                        Component.translatable("pl.book.supply3.page1")
                ));
            });
