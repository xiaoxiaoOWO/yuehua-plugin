...
public final class Ren11 {
    public static void spawn() {
        Location location = new Location(GetEntity.world, 1663, 150, 171, 0, 0);
        Villager villager = GetEntity.world.spawn(location, Villager.class, false, it -> {
            ...
            it.customName(Component.translatable("pl.npc.name.ren11"));
            ...
            buyItem.editMeta(meta -> {
                meta.displayName(Component.translatable("pl.npc.name.ren11"));
                meta.lore(List.of(
                        Component.translatable("pl.npc.chat1a.ren11"),
                        Component.translatable("pl.npc.chat1b.ren11")
                ));
            });
            ...
            sellItem.editMeta(meta -> {
                meta.displayName(Component.translatable("pl.npc.name.ren11"));
                meta.lore(List.of(
                        Component.translatable("pl.npc.chat2a.ren11"),
                        Component.translatable("pl.npc.chat2b.ren11")
                ));
            });
