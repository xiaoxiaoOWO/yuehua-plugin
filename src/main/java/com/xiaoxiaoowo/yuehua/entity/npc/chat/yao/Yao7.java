...
public final class Yao7 {
    public static void spawn() {
        Location location = new Location(GetEntity.world, 2727, 80, 825, 180, 0);
        Villager villager = GetEntity.world.spawn(location, Villager.class, false, it -> {
            ...
            it.setAge(100000000);
            it.customName(Component.translatable("pl.npc.name.yao7"));
            ...
            buyItem.editMeta(meta -> {
                meta.displayName(Component.translatable("pl.npc.name.yao7"));
                meta.lore(List.of(
                        Component.translatable("pl.npc.chat1a.yao7")
                ));
            });
            ...
            sellItem.editMeta(meta -> {
                meta.displayName(Component.translatable("pl.npc.name.yao7"));
                meta.lore(List.of(
                        Component.translatable("pl.npc.chat2a.yao7")
                ));
            });
