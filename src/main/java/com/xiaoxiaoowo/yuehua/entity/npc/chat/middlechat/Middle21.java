...
public final class Middle21 {
    public static void spawn() {
        Location location = new Location(GetEntity.world, 100.5, 46, 168.5, 180, 0);
        Villager villager = GetEntity.world.spawn(location, Villager.class, false, it -> {
            ...
            it.customName(Component.translatable("pl.npc.name.middle21"));
            ...
            // 对话交易
            {
                ...
                buyItem.editMeta(meta -> {
                    meta.displayName(Component.translatable("pl.npc.name.middle21"));
                    meta.lore(List.of(
                            Component.translatable("pl.npc.chat1a.middle21"),
                            Component.translatable("pl.npc.chat1b.middle21")
                    ));
                });
                ...
                sellItem.editMeta(meta -> {
                    meta.displayName(Component.translatable("pl.npc.name.middle21"));
                    meta.lore(List.of(
                            Component.translatable("pl.npc.chat2a.middle21"),
                            Component.translatable("pl.npc.chat2b.middle21")
                    ));
                });
