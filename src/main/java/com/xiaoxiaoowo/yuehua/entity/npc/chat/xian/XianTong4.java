...
public final class XianTong4 {
    public static void spawn() {
        Location location = new Location(GetEntity.world, 3207.5, 85, 860.5, 180, 0);
        Villager villager = GetEntity.world.spawn(location, Villager.class, false, it -> {
            ...
            it.customName(Component.translatable("pl.npc.name.xiantong4"));
            ...
            recipe0.addIngredient(RaceProvince.xian.clone());
