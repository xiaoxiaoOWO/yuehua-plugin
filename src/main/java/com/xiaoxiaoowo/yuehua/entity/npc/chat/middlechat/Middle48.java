...
public final class Middle48 {
    public static void spawn() {
        Location location = new Location(GetEntity.world, 64, 48, 88, 180, 0);
        Villager villager = GetEntity.world.spawn(location, Villager.class, false, it -> {
            ...
            it.customName(Component.translatable("pl.npc.name.middle48"));
            ...
            buyItem.editMeta(meta -> {
                meta.displayName(Component.translatable("pl.npc.name.middle48"));
                meta.lore(List.of(
                        Component.translatable("pl.npc.chat1a.middle48")
                ));
            });
            ...
            sellItem.editMeta(meta -> {
                meta.displayName(Component.translatable("pl.npc.name.middle48"));
                meta.lore(List.of(
                        Component.translatable("pl.npc.chat2a.middle48")
                ));
            });
