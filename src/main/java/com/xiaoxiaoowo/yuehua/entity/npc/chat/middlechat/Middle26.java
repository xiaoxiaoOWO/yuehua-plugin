...
public final class Middle26 {
    public static void spawn() {
        Location location = new Location(GetEntity.world, 123.5, 48, 120.5, 180, 0);
        Villager villager = GetEntity.world.spawn(location, Villager.class, false, it -> {
            ...
            it.customName(Component.translatable("pl.npc.name.middle26"));
            ...
            buyItem.editMeta(meta -> {
                meta.displayName(Component.translatable("pl.npc.name.middle26"));
                meta.lore(List.of(
                        Component.translatable("pl.npc.chat1a.middle26"),
                        Component.translatable("pl.npc.chat1b.middle26")
                ));
            });
            ...
            sellItem.editMeta(meta -> {
                meta.displayName(Component.translatable("pl.npc.name.middle26"));
                meta.lore(List.of(
                        Component.translatable("pl.npc.chat2a.middle26"),
                        Component.translatable("pl.npc.chat2b.middle26")
                ));
            });
