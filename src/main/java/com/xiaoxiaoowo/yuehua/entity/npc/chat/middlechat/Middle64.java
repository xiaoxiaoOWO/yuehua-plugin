...
public final class Middle64 {
    public static void spawn() {
        Location location = new Location(GetEntity.world, 181, 65, -229, 180, 0);
        Villager villager = GetEntity.world.spawn(location, Villager.class, false, it -> {
            ...
            it.customName(Component.translatable("pl.npc.name.middle64"));
            ...
            buyItem.editMeta(meta -> {
                meta.displayName(Component.translatable("pl.npc.name.middle64"));
                meta.lore(List.of(
                        Component.translatable("pl.npc.chat1a.middle64"),
                        Component.translatable("pl.npc.chat1b.middle64")
                ));
            });
            ...
            sellItem.editMeta(meta -> {
                meta.displayName(Component.translatable("pl.npc.name.middle64"));
                meta.lore(List.of(
                        Component.translatable("pl.npc.chat2a.middle64")
                ));
            });
