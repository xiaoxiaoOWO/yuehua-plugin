...
public final class Middle32 {
    public static void spawn() {
        Location location = new Location(GetEntity.world, 172, 47, 125, 180, 0);
        Villager villager = GetEntity.world.spawn(location, Villager.class, false, it -> {
            ...
            it.customName(Component.translatable("pl.npc.name.middle32"));
            ...
            buyItem.editMeta(meta -> {
                meta.displayName(Component.translatable("pl.npc.name.middle32"));
                meta.lore(List.of(
                        Component.translatable("pl.npc.chat1a.middle32"),
                        Component.translatable("pl.npc.chat1b.middle32")
                ));
            });
            ...
            sellItem.editMeta(meta -> {
                meta.displayName(Component.translatable("pl.npc.name.middle32"));
                meta.lore(List.of(
                        Component.translatable("pl.npc.chat2a.middle32"),
                        Component.translatable("pl.npc.chat2b.middle32")
                ));
            });
