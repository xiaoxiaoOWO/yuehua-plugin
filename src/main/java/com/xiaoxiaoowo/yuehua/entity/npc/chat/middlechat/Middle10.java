...
public final class Middle10 {
    public static void spawn() {
        Location location = new Location(GetEntity.world, 87.5, 46, 189.5, 180, 0);
        Villager villager = GetEntity.world.spawn(location, Villager.class, false, it -> {
            ...
            it.customName(Component.translatable("pl.npc.name.middle10"));
            ...
            buyItem.editMeta(meta -> {
                meta.displayName(Component.translatable("pl.npc.name.middle10"));
                meta.lore(List.of(Component.translatable("pl.npc.chat1a.middle10")));
            });

            ItemStack sellItem = new ItemStack(Material.LIME_DYE, 1);
            sellItem.editMeta(meta -> {
                meta.displayName(Component.translatable("pl.npc.name.middle10"));
                meta.lore(List.of(Component.translatable("pl.npc.chat2a.middle10")));
            });
