...
public final class Qiansi1 {
    public static void spawn() {
        Location location = new Location(GetEntity.world, -647, 109, 448, 0, 0);
        Villager villager = GetEntity.world.spawn(location, Villager.class, false, it -> {
            ...
            it.customName(Component.translatable("pl.npc.name.qiansi1"));
            ...
            buyItem.editMeta(meta -> {
                ...
                itemMeta.displayName(Component.translatable("pl.npc.name.qiansi1"));
                itemMeta.lore(List.of(
                        Component.translatable("pl.npc.chat1a.qiansi1")
                ));
            });
            ...
            sellItem.editMeta(meta -> {
                ...
                itemMeta.displayName(Component.translatable("pl.npc.name.qiansi1"));
                itemMeta.lore(List.of(
                        Component.translatable("pl.npc.chat2a.qiansi1")
                ));
            });
