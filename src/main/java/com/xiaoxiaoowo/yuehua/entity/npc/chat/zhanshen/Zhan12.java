...
public final class Zhan12 {
    public static void spawn() {
        Location location = new Location(GetEntity.world, 3299, 36, -220, 0, 0);
        Villager villager = GetEntity.world.spawn(location, Villager.class, false, it -> {
            ...
            it.setAge(100000000);
            it.customName(Component.translatable("pl.npc.name.zhan12"));
            ...
            buyItem.editMeta(meta -> {
                meta.displayName(Component.translatable("pl.npc.name.zhan12"));
                meta.lore(List.of(
                        Component.translatable("pl.npc.chat1a.zhan12")
                ));
            });
            ...
            sellItem.editMeta(meta -> {
                meta.displayName(Component.translatable("pl.npc.name.zhan12"));
                meta.lore(List.of(
                        Component.translatable("pl.npc.chat2a.zhan12")
                ));
            });
