...
public final class Qiansi7 {
    public static void spawn() {
        Location location = new Location(GetEntity.world, -803, 102, 406, 0, 0);
        Villager villager = GetEntity.world.spawn(location, Villager.class, false, it -> {
            ...
            it.customName(Component.translatable("pl.npc.name.qiansi7"));
            ...
            buyItem.editMeta(meta -> {
                ...
                itemMeta.displayName(Component.translatable("pl.npc.name.qiansi7"));
                itemMeta.lore(List.of(
                        Component.translatable("pl.npc.chat1a.qiansi7")
                ));
            });
            ...
            sellItem.editMeta(meta -> {
                ...
                itemMeta.displayName(Component.translatable("pl.npc.name.qiansi7"));
                itemMeta.lore(List.of(
                        Component.translatable("pl.npc.chat2a.qiansi7")
                ));
            });
