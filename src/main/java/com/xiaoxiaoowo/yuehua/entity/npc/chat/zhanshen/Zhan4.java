...
public final class Zhan4 {
    public static void spawn() {
        Location location = new Location(GetEntity.world, 3300, 20, -113, 0, 0);
        Villager villager = GetEntity.world.spawn(location, Villager.class, false, it -> {
            ...
            it.setAge(100000000);
            it.customName(Component.translatable("pl.npc.name.zhan4"));
            ...
            buyItem.editMeta(meta -> {
                meta.displayName(Component.translatable("pl.npc.name.zhan4"));
                meta.lore(List.of(
                        Component.translatable("pl.npc.chat1a.zhan4")
                ));
            });
            ...
            sellItem.editMeta(meta -> {
                meta.displayName(Component.translatable("pl.npc.name.zhan4"));
                meta.lore(List.of(
                        Component.translatable("pl.npc.chat2a.zhan4"),
                        Component.translatable("pl.npc.chat2b.zhan4")
                ));
            });
