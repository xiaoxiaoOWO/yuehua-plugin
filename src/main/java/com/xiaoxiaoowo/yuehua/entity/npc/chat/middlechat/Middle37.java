...
public final class Middle37 {
    public static void spawn() {
        Location location = new Location(GetEntity.world, 237, 47, 135, 180, 0);
        Villager villager = GetEntity.world.spawn(location, Villager.class, false, it -> {
            ...
            it.customName(Component.translatable("pl.npc.name.middle37"));
            ...
            buyItem.editMeta(meta -> {
                meta.displayName(Component.translatable("pl.npc.name.middle37"));
                meta.lore(List.of(
                        Component.translatable("pl.npc.chat1a.middle37")
                ));
            });
            ...
            sellItem.editMeta(meta -> {
                meta.displayName(Component.translatable("pl.npc.name.middle37"));
                meta.lore(List.of(
                        Component.translatable("pl.npc.chat2a.middle37")
                ));
            });
