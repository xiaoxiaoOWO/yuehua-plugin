...
public final class South2 {
    public static void spawn() {
        Location location = new Location(GetEntity.world, -329, 58, 599, 180, 0);
        Villager villager = GetEntity.world.spawn(location, Villager.class, false, it -> {
            ...
            it.customName(Component.translatable("pl.npc.name.south2"));
            ...
            buyItem.editMeta(meta -> {
                meta.displayName(Component.translatable("pl.npc.name.south2"));
                meta.lore(List.of(
                        Component.translatable("pl.npc.chat1a.south2"),
                        Component.translatable("pl.npc.chat1b.south2")
                ));
            });
            ...
            sellItem.editMeta(meta -> {
                meta.displayName(Component.translatable("pl.npc.name.south2"));
                meta.lore(List.of(
                        Component.translatable("pl.npc.chat2a.south2"),
                        Component.translatable("pl.npc.chat2b.south2")
                ));
            });
