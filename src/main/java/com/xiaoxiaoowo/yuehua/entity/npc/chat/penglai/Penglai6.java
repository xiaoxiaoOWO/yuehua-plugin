...
public final class Penglai6 {
    public static void spawn() {
        Location location = new Location(GetEntity.world, 381, 42, -694, 180, 0);
        Villager villager = GetEntity.world.spawn(location, Villager.class, false, it -> {
            ...
            it.customName(Component.translatable("pl.npc.name.penglai6"));
            ...
            buyItem.editMeta(meta -> {
                meta.displayName(Component.translatable("pl.npc.name.penglai6"));
                meta.lore(List.of(Component.translatable("pl.npc.chat1a.penglai6")));
            });
            ...
            sellItem.editMeta(meta -> {
                meta.displayName(Component.translatable("pl.npc.name.penglai6"));
                meta.lore(List.of(Component.translatable("pl.npc.chat2a.penglai6"), Component.translatable("pl.npc.chat2b.penglai6")));
            });
