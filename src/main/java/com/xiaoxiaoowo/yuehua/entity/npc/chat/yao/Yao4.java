...
public final class Yao4 {
    public static void spawn() {
        Location location = new Location(GetEntity.world, 2739, 44, 864, 180, 0);
        Villager villager = GetEntity.world.spawn(location, Villager.class, false, it -> {
            ...
            it.setAge(100000000);
            it.customName(Component.translatable("pl.npc.name.yao4"));
            ...
            buyItem.editMeta(meta -> {
                meta.displayName(Component.translatable("pl.npc.name.yao4"));
                meta.lore(List.of(
                        Component.translatable("pl.npc.chat1a.yao4"),
                        Component.translatable("pl.npc.chat1b.yao4")
                ));
            });
            ...
            sellItem.editMeta(meta -> {
                meta.displayName(Component.translatable("pl.npc.name.yao4"));
                meta.lore(List.of(
                        Component.translatable("pl.npc.chat2a.yao4"),
                        Component.translatable("pl.npc.chat2b.yao4")
                ));
            });
