...
public final class Middle16 {
    public static void spawn() {
        Location location = new Location(GetEntity.world, 89.5, 46, 134.5, 180, 0);
        Villager villager = GetEntity.world.spawn(location, Villager.class, false, it -> {
            ...
            it.customName(Component.translatable("pl.npc.name.middle16"));
            ...
            buyItem.editMeta(meta -> {
                meta.displayName(Component.translatable("pl.npc.name.middle16"));
                meta.lore(List.of(Component.translatable("pl.npc.chat1a.middle16")));
            });
            ...
            sellItem.editMeta(meta -> {
                meta.displayName(Component.translatable("pl.npc.name.middle16"));
                meta.lore(List.of(
                        Component.translatable("pl.npc.chat2a.middle16"),
                        Component.translatable("pl.npc.chat2b.middle16")
                ));
            });
