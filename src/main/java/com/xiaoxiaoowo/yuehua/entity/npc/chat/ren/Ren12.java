...
public final class Ren12 {
    public static void spawn() {
        Location location = new Location(GetEntity.world, 1626, 136, 105, 0, 0);
        Villager villager = GetEntity.world.spawn(location, Villager.class, false, it -> {
            ...
            it.customName(Component.translatable("pl.npc.name.ren12"));
            ...
            buyItem.editMeta(meta -> {
                meta.displayName(Component.translatable("pl.npc.name.ren12"));
                meta.lore(List.of(
                        Component.translatable("pl.npc.chat1a.ren12"),
                        Component.translatable("pl.npc.chat1b.ren12")
                ));
            });
            ...
            sellItem.editMeta(meta -> {
                meta.displayName(Component.translatable("pl.npc.name.ren12"));
                meta.lore(List.of(
                        Component.translatable("pl.npc.chat2a.ren12"),
                        Component.translatable("pl.npc.chat2b.ren12")
                ));
            });
