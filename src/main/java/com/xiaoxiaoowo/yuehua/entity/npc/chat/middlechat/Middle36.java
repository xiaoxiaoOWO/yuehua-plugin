...
public final class Middle36 {
    public static void spawn() {
        Location location = new Location(GetEntity.world, 202, 46, 155, 180, 0);
        Villager villager = GetEntity.world.spawn(location, Villager.class, false, it -> {
            ...
            it.customName(Component.translatable("pl.npc.name.middle36"));
            ...
            buyItem.editMeta(meta -> {
                meta.displayName(Component.translatable("pl.npc.name.middle36"));
                meta.lore(List.of(
                        Component.translatable("pl.npc.chat1a.middle36"),
                        Component.translatable("pl.npc.chat1b.middle36")
                ));
            });
            ...
            sellItem.editMeta(meta -> {
                meta.displayName(Component.translatable("pl.npc.name.middle36"));
                meta.lore(List.of(
                        Component.translatable("pl.npc.chat2a.middle36")
                ));
            });
