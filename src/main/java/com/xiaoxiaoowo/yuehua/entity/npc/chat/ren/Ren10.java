...
public final class Ren10 {
    public static void spawn() {
        Location location = new Location(GetEntity.world, 1714, 150, 105, 0, 0);
        Villager villager = GetEntity.world.spawn(location, Villager.class, false, it -> {
            ...
            it.customName(Component.translatable("pl.npc.name.ren10"));
            ...
            buyItem.editMeta(meta -> {
                meta.displayName(Component.translatable("pl.npc.name.ren10"));
                meta.lore(List.of(
                        Component.translatable("pl.npc.chat1a.ren10")
                ));
            });
            ...
            sellItem.editMeta(meta -> {
                meta.displayName(Component.translatable("pl.npc.name.ren10"));
                meta.lore(List.of(
                        Component.translatable("pl.npc.chat2a.ren10"),
                        Component.translatable("pl.npc.chat2b.ren10")
                ));
            });
