...
public final class Middle47 {
    public static void spawn() {
        Location location = new Location(GetEntity.world, 60, 48, 84, 180, 0);
        Villager villager = GetEntity.world.spawn(location, Villager.class, false, it -> {
            ...
            it.customName(Component.translatable("pl.npc.name.middle47"));
            ...
            buyItem.editMeta(meta -> {
                meta.displayName(Component.translatable("pl.npc.name.middle47"));
                meta.lore(List.of(
                        Component.translatable("pl.npc.chat1a.middle47")
                ));
            });
            ...
            sellItem.editMeta(meta -> {
                meta.displayName(Component.translatable("pl.npc.name.middle47"));
                meta.lore(List.of(
                        Component.translatable("pl.npc.chat2a.middle47")
                ));
            });
