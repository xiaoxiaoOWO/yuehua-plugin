...
public final class Ren1 {
    public static void spawn() {
        Location location = new Location(GetEntity.world, 1666, 148, 127, 0, 0);
        Villager villager = GetEntity.world.spawn(location, Villager.class, false, it -> {
            ...
            it.customName(Component.translatable("pl.npc.name.ren1"));
            ...
            buyItem.editMeta(meta -> {
                meta.displayName(Component.translatable("pl.npc.name.ren1"));
                meta.lore(List.of(
                        Component.translatable("pl.npc.chat1a.ren1"),
                        Component.translatable("pl.npc.chat1b.ren1")
                ));
            });
            ...
            sellItem.editMeta(meta -> {
                meta.displayName(Component.translatable("pl.npc.name.ren1"));
                meta.lore(List.of(
                        Component.translatable("pl.npc.chat2a.ren1"),
                        Component.translatable("pl.npc.chat2b.ren1")
                ));
            });
