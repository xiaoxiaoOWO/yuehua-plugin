...
public final class Re2 {
    public static void spawn() {
        Location location = new Location(GetEntity.world, 807, 26, -69, 180, 0);
        Villager villager = GetEntity.world.spawn(location, Villager.class, false, it -> {
            ...
            it.customName(Component.translatable("pl.npc.name.re2"));
            ...
            buyItem.editMeta(meta -> {
                meta.displayName(Component.translatable("pl.npc.name.re2"));
                meta.lore(List.of(
                        Component.translatable("pl.npc.chat1a.re2"),
                        Component.translatable("pl.npc.chat1b.re2")
                ));
            });
            ...
            sellItem.editMeta(meta -> {
                meta.displayName(Component.translatable("pl.npc.name.re2"));
                meta.lore(List.of(
                        Component.translatable("pl.npc.chat2a.re2"),
                        Component.translatable("pl.npc.chat2b.re2")
                ));
            });
