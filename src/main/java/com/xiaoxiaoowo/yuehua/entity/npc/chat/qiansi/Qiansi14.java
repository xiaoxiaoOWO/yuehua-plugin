...
public final class Qiansi14 {
    public static void spawn() {
        Location location = new Location(GetEntity.world, -640, 140, 367, 0, 0);
        Villager villager = GetEntity.world.spawn(location, Villager.class, false, it -> {
            ...
            it.customName(Component.translatable("pl.npc.name.qiansi14"));
            ...
            buyItem.editMeta(meta -> {
                ...
                itemMeta.displayName(Component.translatable("pl.npc.name.qiansi14"));
                itemMeta.lore(List.of(
                        Component.translatable("pl.npc.chat1a.qiansi14")
                ));
            });
            ...
            sellItem.editMeta(meta -> {
                ...
                itemMeta.displayName(Component.translatable("pl.npc.name.qiansi14"));
                itemMeta.lore(List.of(
                        Component.translatable("pl.npc.chat2a.qiansi14")
                ));
            });
