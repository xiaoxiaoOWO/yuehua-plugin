...
public final class Middle12 {
    public static void spawn() {
        Location location = new Location(GetEntity.world, 132.5, 46, 173.5, 180, 0);
        Villager villager = GetEntity.world.spawn(location, Villager.class, false, it -> {
            ...
            it.customName(Component.translatable("pl.npc.name.middle12"));
            ...
            buyItem.editMeta(meta -> {
                meta.displayName(Component.translatable("pl.npc.name.middle12"));
                meta.lore(List.of(
                        Component.translatable("pl.npc.chat1a.middle12"),
                        Component.translatable("pl.npc.chat1b.middle12")
                ));
            });
            ...
            sellItem.editMeta(meta -> {
                meta.displayName(Component.translatable("pl.npc.name.middle12"));
                meta.lore(List.of(Component.translatable("pl.npc.chat2a.middle12")));
            });
