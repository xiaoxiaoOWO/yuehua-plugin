...
public final class Middle31 {
    public static void spawn() {
        Location location = new Location(GetEntity.world, 186, 47, 138, 180, 0);
        Villager villager = GetEntity.world.spawn(location, Villager.class, false, it -> {
            ...
            it.customName(Component.translatable("pl.npc.name.middle31"));
            ...
            buyItem.editMeta(meta -> {
                meta.displayName(Component.translatable("pl.npc.name.middle31"));
                meta.lore(List.of(
                        Component.translatable("pl.npc.chat1a.middle31")
                ));
            });
            ...
            sellItem.editMeta(meta -> {
                meta.displayName(Component.translatable("pl.npc.name.middle31"));
                meta.lore(List.of(
                        Component.translatable("pl.npc.chat2a.middle31")
                ));
            });
