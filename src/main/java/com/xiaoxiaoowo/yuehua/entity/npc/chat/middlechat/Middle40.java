...
public final class Middle40 {
    public static void spawn() {
        Location location = new Location(GetEntity.world, 294, 44, 130, 180, 0);
        Villager villager = GetEntity.world.spawn(location, Villager.class, false, it -> {
            ...
            it.customName(Component.translatable("pl.npc.name.middle40"));
            ...
            buyItem.editMeta(meta -> {
                meta.displayName(Component.translatable("pl.npc.name.middle40"));
                meta.lore(List.of(
                        Component.translatable("pl.npc.chat1a.middle40"),
                        Component.translatable("pl.npc.chat1b.middle40")
                ));
            });
            ...
            sellItem.editMeta(meta -> {
                meta.displayName(Component.translatable("pl.npc.name.middle40"));
                meta.lore(List.of(
                        Component.translatable("pl.npc.chat2a.middle40")
                ));
            });
