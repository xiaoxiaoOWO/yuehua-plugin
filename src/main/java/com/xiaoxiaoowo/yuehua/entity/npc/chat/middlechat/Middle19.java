...
public final class Middle19 {
    public static void spawn() {
        Location location = new Location(GetEntity.world, 106.5, 46, 153.5, 180, 0);
        Villager villager = GetEntity.world.spawn(location, Villager.class, false, it -> {
            ...
            it.customName(Component.translatable("pl.npc.name.middle19"));
            ...
            // 对话交易
            {
                ...
                buyItem.editMeta(meta -> {
                    meta.displayName(Component.translatable("pl.npc.name.middle19"));
                    meta.lore(List.of(
                            Component.translatable("pl.npc.chat1a.middle19"),
                            Component.translatable("pl.npc.chat1b.middle19")
                    ));
                });
                ...
                sellItem.editMeta(meta -> {
                    meta.displayName(Component.translatable("pl.npc.name.middle19"));
                    meta.lore(List.of(
                            Component.translatable("pl.npc.chat2a.middle19"),
                            Component.translatable("pl.npc.chat2b.middle19")
                    ));
                });
