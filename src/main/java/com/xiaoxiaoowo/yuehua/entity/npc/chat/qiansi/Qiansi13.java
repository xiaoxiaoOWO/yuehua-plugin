...
public final class Qiansi13 {
    public static void spawn() {
        Location location = new Location(GetEntity.world, -685, 115, 400, 0, 0);
        Villager villager = GetEntity.world.spawn(location, Villager.class, false, it -> {
            ...
            it.customName(Component.translatable("pl.npc.name.qiansi13"));
            ...
            buyItem.editMeta(meta -> {
                ...
                itemMeta.displayName(Component.translatable("pl.npc.name.qiansi13"));
                itemMeta.lore(List.of(
                        Component.translatable("pl.npc.chat1a.qiansi13")
                ));
            });
            ...
            sellItem.editMeta(meta -> {
                ...
                itemMeta.displayName(Component.translatable("pl.npc.name.qiansi13"));
                itemMeta.lore(List.of(
                        Component.translatable("pl.npc.chat2a.qiansi13")
                ));
            });
