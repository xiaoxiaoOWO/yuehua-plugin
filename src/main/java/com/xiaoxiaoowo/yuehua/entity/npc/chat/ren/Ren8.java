...
public final class Ren8 {
    public static void spawn() {
        Location location = new Location(GetEntity.world, 1777, 147, 187, 0, 0);
        Villager villager = GetEntity.world.spawn(location, Villager.class, false, it -> {
            ...
            it.customName(Component.translatable("pl.npc.name.ren8"));
            ...
            buyItem.editMeta(meta -> {
                meta.displayName(Component.translatable("pl.npc.name.ren8"));
                meta.lore(List.of(
                        Component.translatable("pl.npc.chat1a.ren8")
                ));
            });
            ...
            sellItem.editMeta(meta -> {
                meta.displayName(Component.translatable("pl.npc.name.ren8"));
                meta.lore(List.of(
                        Component.translatable("pl.npc.chat2a.ren8"),
                        Component.translatable("pl.npc.chat2b.ren8")
                ));
            });
