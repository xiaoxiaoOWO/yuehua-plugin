...
public final class Middle3 {
    public static void spawn() {
        Location location = new Location(GetEntity.world, 54.5, 7, 18.5, 180, 0);
        Villager villager = GetEntity.world.spawn(location, Villager.class, false, it -> {
            ...
            it.customName(Component.translatable("pl.npc.name.middle3"));
            ...
            // 对话交易
            {
                ...
                buyItem.editMeta(meta -> {
                    meta.displayName(Component.translatable("pl.npc.name.middle3"));
                    meta.lore(List.of(Component.translatable("pl.npc.chat1a.middle3")));
                });

                ItemStack sellItem = new ItemStack(Material.LIME_DYE, 1);
                sellItem.editMeta(meta -> {
                    meta.displayName(Component.translatable("pl.npc.name.middle3"));
                    meta.lore(List.of(Component.translatable("pl.npc.chat2a.middle3")));
                });
            ...
            // 硬币兑换
            {
                ItemStack buyItem = Herb.RenShen.clone();
                ItemStack sellItem = Money.jinYuanBao.clone();
