...
public final class Middle5 {
    public static void spawn() {
        Location location = new Location(GetEntity.world, 167.5, 46, 178.5, 180, 0);
        Villager villager = GetEntity.world.spawn(location, Villager.class, false, it -> {
            ...
            it.customName(Component.translatable("pl.npc.name.middle5"));
            ...
            buyItem.editMeta(meta -> {
                meta.displayName(Component.translatable("pl.npc.name.middle5"));
                meta.lore(List.of(Component.translatable("pl.npc.chat1a.middle5")));
            });

            ItemStack sellItem = new ItemStack(Material.LIME_DYE, 1);
            sellItem.editMeta(meta -> {
                meta.displayName(Component.translatable("pl.npc.name.middle5"));
                meta.lore(List.of(Component.translatable("pl.npc.chat2a.middle5")));
            });
