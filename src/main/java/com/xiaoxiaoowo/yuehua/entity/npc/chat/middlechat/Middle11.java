...
public final class Middle11 {
    public static void spawn() {
        Location location = new Location(GetEntity.world, 69.5, 46, 183.5, 180, 0);
        Villager villager = GetEntity.world.spawn(location, Villager.class, false, it -> {
            ...
            it.customName(Component.translatable("pl.npc.name.middle11"));
            ...
            buyItem.editMeta(meta -> {
                meta.displayName(Component.translatable("pl.npc.name.middle11"));
                meta.lore(List.of(Component.translatable("pl.npc.chat1a.middle11")));
            });

            ItemStack sellItem = new ItemStack(Material.LIME_DYE, 1);
            sellItem.editMeta(meta -> {
                meta.displayName(Component.translatable("pl.npc.name.middle11"));
                meta.lore(List.of(Component.translatable("pl.npc.chat2a.middle11")));
            });
