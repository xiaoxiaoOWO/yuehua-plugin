...
public final class Zhan8 {
    public static void spawn() {
        Location location = new Location(GetEntity.world, 3300, 20, -163, 0, 0);
        Villager villager = GetEntity.world.spawn(location, Villager.class, false, it -> {
            ...
            it.setAge(100000000);
            it.customName(Component.translatable("pl.npc.name.zhan8"));
            ...
            buyItem.editMeta(meta -> {
                meta.displayName(Component.translatable("pl.npc.name.zhan8"));
                meta.lore(List.of(
                        Component.translatable("pl.npc.chat1a.zhan8"),
                        Component.translatable("pl.npc.chat1b.zhan8")
                ));
            });
            ...
            sellItem.editMeta(meta -> {
                meta.displayName(Component.translatable("pl.npc.name.zhan8"));
                meta.lore(List.of(
                        Component.translatable("pl.npc.chat2a.zhan8")
                ));
            });
