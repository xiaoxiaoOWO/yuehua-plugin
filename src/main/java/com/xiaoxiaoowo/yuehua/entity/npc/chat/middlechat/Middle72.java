...
public final class Middle72 {
    public static void spawn() {
        Location location = new Location(GetEntity.world, 231, 47, 181, 180, 0);
        Villager villager = GetEntity.world.spawn(location, Villager.class, false, it -> {
            ...
            it.customName(Component.translatable("pl.npc.name.middle72"));
            ...
            sellItem.editMeta(meta -> {
                ...
                bookMeta.displayName(Component.text("§9失踪的宠物"));
