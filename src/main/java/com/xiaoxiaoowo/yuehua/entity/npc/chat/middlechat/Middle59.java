...
public final class Middle59 {
    public static void spawn() {
        Location location = new Location(GetEntity.world, 54, 47, 109, 180, 0);
        Villager villager = GetEntity.world.spawn(location, Villager.class, false, it -> {
            ...
            it.customName(Component.translatable("pl.npc.name.middle59"));
            ...
            buyItem.editMeta(meta -> {
                meta.displayName(Component.translatable("pl.npc.name.middle59"));
                meta.lore(List.of(
                        Component.translatable("pl.npc.chat1a.middle59")
                ));
            });
            ...
            sellItem.editMeta(meta -> {
                meta.displayName(Component.translatable("pl.npc.name.middle59"));
                meta.lore(List.of(
                        Component.translatable("pl.npc.chat2a.middle59")
                ));
            });
