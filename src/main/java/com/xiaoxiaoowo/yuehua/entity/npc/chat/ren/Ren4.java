...
public final class Ren4 {
    public static void spawn() {
        Location location = new Location(GetEntity.world, 1756, 156, 140, 0, 0);
        Villager villager = GetEntity.world.spawn(location, Villager.class, false, it -> {
            ...
            it.customName(Component.translatable("pl.npc.name.ren4"));
            ...
            buyItem.editMeta(meta -> {
                meta.displayName(Component.translatable("pl.npc.name.ren4"));
                meta.lore(List.of(
                        Component.translatable("pl.npc.chat1a.ren4"),
                        Component.translatable("pl.npc.chat1b.ren4")
                ));
            });
            ...
            sellItem.editMeta(meta -> {
                meta.displayName(Component.translatable("pl.npc.name.ren4"));
                meta.lore(List.of(
                        Component.translatable("pl.npc.chat2a.ren4"),
                        Component.translatable("pl.npc.chat2b.ren4")
                ));
            });
