...
public final class Shenmain6 {
    public static void spawn() {
        Location location = new Location(GetEntity.world, 312, 45, -685, 0, 0);
        Villager villager = GetEntity.world.spawn(location, Villager.class, false, it -> {
            ...
            it.customName(Component.translatable("pl.npc.name.shenmain6"));
            ...
            buyItem.editMeta(meta -> {
                ...
                bookMeta.pages(List.of(
                        Component.translatable("pl.book.sm9.page1")
                ));
            });
