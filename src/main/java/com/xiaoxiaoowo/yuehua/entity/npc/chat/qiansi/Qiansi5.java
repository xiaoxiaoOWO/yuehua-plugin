...
public final class Qiansi5 {
    public static void spawn() {
        Location location = new Location(GetEntity.world, -631, 114, 419, 0, 0);
        Villager villager = GetEntity.world.spawn(location, Villager.class, false, it -> {
            ...
            it.customName(Component.translatable("pl.npc.name.qiansi5"));
            ...
            buyItem.editMeta(meta -> {
                ...
                itemMeta.displayName(Component.translatable("pl.npc.name.qiansi5"));
                itemMeta.lore(List.of(
                        Component.translatable("pl.npc.chat1a.qiansi5")
                ));
            });
            ...
            sellItem.editMeta(meta -> {
                ...
                itemMeta.displayName(Component.translatable("pl.npc.name.qiansi5"));
                itemMeta.lore(List.of(
                        Component.translatable("pl.npc.chat2a.qiansi5")
                ));
            });
