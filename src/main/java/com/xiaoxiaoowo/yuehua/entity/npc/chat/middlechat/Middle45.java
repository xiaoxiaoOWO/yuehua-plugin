...
public final class Middle45 {
    public static void spawn() {
        Location location = new Location(GetEntity.world, 237, 45, 59, 180, 0);
        Villager villager = GetEntity.world.spawn(location, Villager.class, false, it -> {
            ...
            it.customName(Component.translatable("pl.npc.name.middle45"));
            ...
            buyItem.editMeta(meta -> {
                meta.displayName(Component.translatable("pl.npc.name.middle45"));
                meta.lore(List.of(
                        Component.translatable("pl.npc.chat1a.middle45")
                ));
            });
            ...
            sellItem.editMeta(meta -> {
                meta.displayName(Component.translatable("pl.npc.name.middle45"));
                meta.lore(List.of(
                        Component.translatable("pl.npc.chat2a.middle45")
                ));
            });
