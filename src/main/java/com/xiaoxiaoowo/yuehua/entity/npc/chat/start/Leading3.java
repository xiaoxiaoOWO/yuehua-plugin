...
public final class Leading3 {
    public static void spawn() {
        Location location = new Location(GetEntity.world, 1362, 77, 66, 0, 0);
        Villager villager = GetEntity.world.spawn(location, Villager.class, false, it -> {
            ...
            it.customName(Component.translatable("pl.npc.name.leading3"));
            ...
            buyItem.editMeta(meta -> {
                ...
                itemMeta.displayName(Component.translatable("pl.npc.name.leading3"));
                itemMeta.lore(List.of(
                        Component.translatable("pl.npc.chat1a.leading3")
                ));
            });
            ...
            sellItem.editMeta(meta -> {
                ...
                itemMeta.displayName(Component.translatable("pl.npc.name.leading3"));
                itemMeta.lore(List.of(
                        Component.translatable("pl.npc.chat2a.leading3"),
                        Component.translatable("pl.npc.chat2b.leading3")
                ));
            });
