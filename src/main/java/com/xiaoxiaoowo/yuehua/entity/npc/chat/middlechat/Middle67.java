...
public final class Middle67 {
    public static void spawn() {
        Location location = new Location(GetEntity.world, 199, 64, -216, 180, 0);
        Villager villager = GetEntity.world.spawn(location, Villager.class, false, it -> {
            ...
            it.customName(Component.translatable("pl.npc.name.middle67"));
            ...
            buyItem.editMeta(meta -> {
                meta.displayName(Component.translatable("pl.npc.name.middle67"));
                meta.lore(List.of(
                        Component.translatable("pl.npc.chat1a.middle67")
                ));
            });
            ...
            sellItem.editMeta(meta -> {
                meta.displayName(Component.translatable("pl.npc.name.middle67"));
                meta.lore(List.of(
                        Component.translatable("pl.npc.chat2a.middle67"),
                        Component.translatable("pl.npc.chat2b.middle67")
                ));
            });
