...
public final class Middle52 {
    public static void spawn() {
        Location location = new Location(GetEntity.world, 93, 48, 57, 180, 0);
        Villager villager = GetEntity.world.spawn(location, Villager.class, false, it -> {
            ...
            it.customName(Component.translatable("pl.npc.name.middle52"));
            ...
            buyItem.editMeta(meta -> {
                meta.displayName(Component.translatable("pl.npc.name.middle52"));
                meta.lore(List.of(
                        Component.translatable("pl.npc.chat1a.middle52"),
                        Component.translatable("pl.npc.chat1b.middle52")
                ));
            });
            ...
            sellItem.editMeta(meta -> {
                meta.displayName(Component.translatable("pl.npc.name.middle52"));
                meta.lore(List.of(
                        Component.translatable("pl.npc.chat2a.middle52")
                ));
            });
