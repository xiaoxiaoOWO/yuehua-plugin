...
public final class Te22 {
    public static void spawn() {
        Location location = new Location(GetEntity.world, -52, 47, 831, 0, 0);
        Villager villager = GetEntity.world.spawn(location, Villager.class, false, it -> {
            ...
            it.customName(Component.translatable("pl.npc.name.te22"));
            ...
            sellItem.editMeta(meta -> {
                ...
                bookMeta.title(Component.text("§9凶神太岁的弱点"));
                bookMeta.author(Component.text("§9研究沙漠生态的学者"));
                bookMeta.pages(List.of(
                        Component.translatable("pl.book.te22.page1"),
                        Component.translatable("pl.book.te22.page2")
                ));
            });
