...
public final class Middle34 {
    public static void spawn() {
        Location location = new Location(GetEntity.world, 189, 47, 98, 180, 0);
        Villager villager = GetEntity.world.spawn(location, Villager.class, false, it -> {
            ...
            it.customName(Component.translatable("pl.npc.name.middle34"));
            ...
            buyItem.editMeta(meta -> {
                meta.displayName(Component.translatable("pl.npc.name.middle34"));
                meta.lore(List.of(
                        Component.translatable("pl.npc.chat1a.middle34"),
                        Component.translatable("pl.npc.chat1b.middle34")
                ));
            });
            ...
            sellItem.editMeta(meta -> {
                meta.displayName(Component.translatable("pl.npc.name.middle34"));
                meta.lore(List.of(
                        Component.translatable("pl.npc.chat2a.middle34")
                ));
            });
