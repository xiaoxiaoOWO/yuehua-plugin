...
public final class North1 {
    public static void spawn() {
        Location location = new Location(GetEntity.world, -310, 18, -703, 0, 0); // 使用指令中的坐标
        Villager villager = GetEntity.world.spawn(location, Villager.class, false, it -> {
            ...
            it.customName(Component.translatable("pl.npc.name.north1"));
            ...
            buyItem.editMeta(meta -> {
                ...
                itemMeta.displayName(Component.translatable("pl.npc.name.north1"));
                itemMeta.lore(List.of(
                        Component.translatable("pl.npc.chat1a.north1"),
                        Component.translatable("pl.npc.chat1b.north1")
                ));
            });
            ...
            sellItem.editMeta(meta -> {
                ...
                itemMeta.displayName(Component.translatable("pl.npc.name.north1"));
                itemMeta.lore(List.of(
                        Component.translatable("pl.npc.chat2a.north1"),
                        Component.translatable("pl.npc.chat2b.north1")
                ));
            });
