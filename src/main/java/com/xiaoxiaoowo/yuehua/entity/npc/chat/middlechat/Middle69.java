...
public final class Middle69 {
    public static void spawn() {
        Location location = new Location(GetEntity.world, 162, 12, 163, 180, 0);
        Villager villager = GetEntity.world.spawn(location, Villager.class, false, it -> {
            ...
            it.customName(Component.translatable("pl.npc.name.middle69"));
            it.setCustomNameVisible(true);

            List<MerchantRecipe> recipes = new ArrayList<>();


            // Book exchange recipe
            ItemStack buyItem = new ItemStack(Material.WRITTEN_BOOK, 1);
            buyItem.editMeta(meta -> {
                BookMeta bookMeta = (BookMeta) meta;
                meta.displayName(Component.text("§9失踪的宠物"));
                bookMeta.author(Component.text("§9辛齐天"));
                bookMeta.pages(List.of(
                        Component.translatable("pl.book.te71a.page1"),
                        Component.translatable("pl.book.te71a.page2")
                ));
            });
