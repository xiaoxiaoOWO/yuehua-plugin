...
public final class Zhan3 {
    public static void spawn() {
        Location location = new Location(GetEntity.world, 3279, 20, -121, 0, 0);
        Villager villager = GetEntity.world.spawn(location, Villager.class, false, it -> {
            ...
            it.setAge(100000000);
            it.customName(Component.translatable("pl.npc.name.zhan3"));
            ...
            buyItem.editMeta(meta -> {
                meta.displayName(Component.translatable("pl.npc.name.zhan3"));
                meta.lore(List.of(
                        Component.translatable("pl.npc.chat1a.zhan3"),
                        Component.translatable("pl.npc.chat1b.zhan3")
                ));
            });
            ...
            sellItem.editMeta(meta -> {
                meta.displayName(Component.translatable("pl.npc.name.zhan3"));
                meta.lore(List.of(
                        Component.translatable("pl.npc.chat2a.zhan3"),
                        Component.translatable("pl.npc.chat2b.zhan3")
                ));
            });
