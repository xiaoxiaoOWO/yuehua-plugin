...
public final class Qiansi11 {
    public static void spawn() {
        Location location = new Location(GetEntity.world, -659, 112, 424, 0, 0);
        Villager villager = GetEntity.world.spawn(location, Villager.class, false, it -> {
            ...
            it.customName(Component.translatable("pl.npc.name.qiansi11"));
            ...
            buyItem.editMeta(meta -> {
                ...
                itemMeta.displayName(Component.translatable("pl.npc.name.qiansi11"));
                itemMeta.lore(List.of(
                        Component.translatable("pl.npc.chat1a.qiansi11")
                ));
            });
            ...
            sellItem.editMeta(meta -> {
                ...
                itemMeta.displayName(Component.translatable("pl.npc.name.qiansi11"));
                itemMeta.lore(List.of(
                        Component.translatable("pl.npc.chat2a.qiansi11")
                ));
            });
