...
public final class Middle9 {
    public static void spawn() {
        Location location = new Location(GetEntity.world, 126.5, 46, 185.5, 180, 0);
        Villager villager = GetEntity.world.spawn(location, Villager.class, false, it -> {
            ...
            it.customName(Component.translatable("pl.npc.name.middle9"));
            ...
            buyItem.editMeta(meta -> {
                meta.displayName(Component.translatable("pl.npc.name.middle9"));
                meta.lore(List.of(
                        Component.translatable("pl.npc.chat1a.middle9"),
                        Component.translatable("pl.npc.chat1b.middle9")
                ));
            });
            ...
            sellItem.editMeta(meta -> {
                meta.displayName(Component.translatable("pl.npc.name.middle9"));
                meta.lore(List.of(
                        Component.translatable("pl.npc.chat2a.middle9"),
                        Component.translatable("pl.npc.chat2b.middle9")
                ));
            });
