...
public final class Middle49 {
    public static void spawn() {
        Location location = new Location(GetEntity.world, 38, 46, 116, 180, 0);
        Villager villager = GetEntity.world.spawn(location, Villager.class, false, it -> {
            ...
            it.customName(Component.translatable("pl.npc.name.middle49"));
            ...
            buyItem.editMeta(meta -> {
                meta.displayName(Component.translatable("pl.npc.name.middle49"));
                meta.lore(List.of(
                        Component.translatable("pl.npc.chat1a.middle49")
                ));
            });
            ...
            sellItem.editMeta(meta -> {
                meta.displayName(Component.translatable("pl.npc.name.middle49"));
                meta.lore(List.of(
                        Component.translatable("pl.npc.chat2a.middle49"),
                        Component.translatable("pl.npc.chat2b.middle49")
                ));
            });
