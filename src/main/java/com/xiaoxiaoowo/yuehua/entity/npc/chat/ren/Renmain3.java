...
public final class Renmain3 {
    public static void spawn() {
        Location location = new Location(GetEntity.world, 1737, 160, 97, 0, 0);
        Villager villager = GetEntity.world.spawn(location, Villager.class, false, it -> {
            ...
            it.customName(Component.translatable("pl.npc.name.renmain3"));
            it.setCustomNameVisible(true);

            List<MerchantRecipe> recipes = new ArrayList<>();

            // Recipe 1: Cocoa Beans for Book
            ...
            sellItem1.editMeta(meta -> {
                ...
                bookMeta.pages(List.of(
                        Component.translatable("pl.book.rm2.page1")
                ));
            });
