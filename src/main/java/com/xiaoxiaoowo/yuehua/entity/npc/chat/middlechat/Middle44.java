...
public final class Middle44 {
    public static void spawn() {
        Location location = new Location(GetEntity.world, 239, 46, 69, 180, 0);
        Villager villager = GetEntity.world.spawn(location, Villager.class, false, it -> {
            ...
            it.customName(Component.translatable("pl.npc.name.middle44"));
            ...
            buyItem.editMeta(meta -> {
                meta.displayName(Component.translatable("pl.npc.name.middle44"));
                meta.lore(List.of(
                        Component.translatable("pl.npc.chat1a.middle44")
                ));
            });
            ...
            sellItem.editMeta(meta -> {
                meta.displayName(Component.translatable("pl.npc.name.middle44"));
                meta.lore(List.of(
                        Component.translatable("pl.npc.chat2a.middle44")
                ));
            });
