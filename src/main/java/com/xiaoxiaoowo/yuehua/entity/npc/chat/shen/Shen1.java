...
public final class Shen1 {
    public static void spawn() {
        Location location = new Location(GetEntity.world, 3328, 156, 152, 0, 0);
        Villager villager = GetEntity.world.spawn(location, Villager.class, false, it -> {
            ...
            it.setAge(100000000);
            it.customName(Component.translatable("pl.npc.name.shen1"));
            ...
            buyItem.editMeta(meta -> {
                meta.displayName(Component.translatable("pl.npc.name.shen1"));
                meta.lore(List.of(Component.translatable("pl.npc.chat1a.shen1")));
            });
            ...
            sellItem.editMeta(meta -> {
                meta.displayName(Component.translatable("pl.npc.name.shen1"));
                meta.lore(List.of(Component.translatable("pl.npc.chat2a.shen1")));
            });
