...
public final class ZhanTong1 {
    public static void spawn() {
        Location location = new Location(GetEntity.world, 3287, 23, -242, -180, 0);
        Villager villager = GetEntity.world.spawn(location, Villager.class, false, it -> {
            ...
            it.customName(Component.translatable("pl.npc.name.zhantong1"));
