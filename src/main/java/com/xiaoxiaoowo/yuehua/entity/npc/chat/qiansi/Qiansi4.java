...
public final class Qiansi4 {
    public static void spawn() {
        Location location = new Location(GetEntity.world, -631, 114, 421, 0, 0);
        Villager villager = GetEntity.world.spawn(location, Villager.class, false, it -> {
            ...
            it.customName(Component.translatable("pl.npc.name.qiansi4"));
            ...
            buyItem.editMeta(meta -> {
                ...
                itemMeta.displayName(Component.translatable("pl.npc.name.qiansi4"));
                itemMeta.lore(List.of(
                        Component.translatable("pl.npc.chat1a.qiansi4")
                ));
            });
            ...
            sellItem.editMeta(meta -> {
                ...
                itemMeta.displayName(Component.translatable("pl.npc.name.qiansi4"));
                itemMeta.lore(List.of(
                        Component.translatable("pl.npc.chat2a.qiansi4")
                ));
            });
