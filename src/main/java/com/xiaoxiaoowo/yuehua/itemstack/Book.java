...
public final class Book {
    ...
    static {
        ...
        dz.setPages(
                "铁匠铺可以为你锻造武器，防具和副武器，当你收集到原始核心和特化露后，将它们交给负责锻造核心的伙计，即可获取装备的锻造核心，再将锻造核心和所需材料放入锻造台即可，当世界止息时锻造台中物品会消失！所以不要遗忘物品到锻造台！也不要在世界即将止息时使用！"
        );
        ...
        shipindz.setPages(
                "明珠堂可以为你锻造饰品，当你收集到原始核心和特化露后，将它们交给负责锻造核心的伙计，即可获取装备的锻造核心，再将锻造核心和所需材料放入锻造台即可，当世界止息时锻造台中物品会消失！所以不要遗忘物品到锻造台！也不要在世界即将止息时使用！"
        );
        ...
        fabaodz.setPages(
                "妙法阁可以为你锻造法宝，当你收集到原始核心和特化露后，将它们交给负责锻造核心的伙计，即可获取装备的锻造核心，再将锻造核心和所需材料放入锻造台即可，当世界止息时锻造台中物品会消失！所以不要遗忘物品到锻造台！也不要在世界即将止息时使用！"
        );
        ...
        yiqidz.setPages(
                "异宝楼可以为你锻造异器，当你收集到原始核心和特化露后，将它们交给负责锻造核心的伙计，即可获取装备的锻造核心，再将锻造核心和所需材料放入锻造台即可，当世界止息时锻造台中物品会消失！所以不要遗忘物品到锻造台！也不要在世界即将止息时使用！"
        );
        ...
        yuehua.setPages(
                ...
                """
                        §aGUI篇§r：请打开强制使用Unicode字体，以及调整好界面大小和聊天框宽度以获得美好体验。饥饿条右侧展示的属性从第一排开始分别为攻击属性，暴击率，暴击效果，冷却缩减，护甲，破甲，法抗，破法，当前护盾值与守护，格挡，韧性，生机，当前血量与最大血量，当前饥饿和最大饥饿，毒伤免疫，火伤免疫，冰伤免疫，箭伤免疫，摔落免疫，三叉戟伤免疫""",
                """
                        §a护甲与破甲篇§r：玩家的近战攻击与箭的伤害，战士弓箭手副武器的伤害，以及怪物的所有非技能伤害都属于物理伤害，受到护甲破甲的影响，怪物的护甲没有上限值，怪物没有破甲，玩家的护甲上限为§b80§r，破甲没有上限，每§b1§r点护甲将减少§b1§r%物理伤害，而每§b1§r点破甲将无视§b1§r点护甲""",
                """
                        §a法抗与破法篇§r：玩家和怪物以及各种副本机制的技能伤害都属于法伤，怪物的法抗没有上限值，怪物没有破法，玩家的法抗上限为§b80§r，破法没有上限，每§b1§r点法抗将减少§b1§r%法术伤害，而每§b1§r点破法将无视§b1§r点法抗""",
                """
                        §a格挡篇§r：物理伤害和法术伤害都将被格挡影响，但其它伤害如摔落伤害不受影响，格挡是怪物玩家共有属性且没有上限，每§b1§r点格挡将在伤害最终计算前减少§b1§r点伤害，所谓的最终计算，就是会先计算护甲，法抗以及各类型伤害免疫，最后一步才计算格挡""",
                """
                        §a毒伤免疫篇§r：毒伤包括中毒和凋零两种状态效果的伤害§8（要注意，月华修改了这个伤害对玩家的数值，每一次伤害都是§b10§8%最大生命值）§r，但不包括非状态效果的中毒伤害，例如，BOSS技能导致玩家中毒，但状态栏没有中毒DEBUFF，因此不属于状态效果，因此该中毒伤害不受毒免影响§8（受法抗影响，因为是技能伤害）§r，每§b1§r%毒免可减少§b1§r%的毒伤""",
                """
                        §a火伤免疫篇§r：火伤包括接触火，岩浆，岩浆块和着火的伤害，与毒伤一样，技能导致的火焰类型伤害受法抗影响，月华同样修改了火伤对玩家的伤害，也是每次§b10§r%最大生命值，每§b1§r%火免减少§b1§r%火伤""",
                """
                        §a冰伤免疫篇§r：冰伤则是MC原版冰冻效果造成的伤害，也不包括技能冰伤，每一次冰伤对玩家造成§b10§r%最大生命值伤害，每§b1§r%冰免减少§b1§r%冰伤

                        §a摔落伤免疫篇§r：玩家受到的摔落伤害，每§b1§r点将转化为§b5§r%最大生命值伤害，每§b1§r%摔落伤免疫减少§b1§r%摔落伤""",
                """
                        §a箭伤免疫篇§r：每§b1§r%箭伤免疫减少§b1§r%箭伤

                        §a三叉戟伤免疫篇§r：每§b1§r%三叉戟伤免疫减少§b1§r%三叉戟伤害""",
                """
                        §a韧性篇§r：韧性是玩家和怪物共有的属性，玩家韧性上限为§b80§r，它的作用是减少持续性非伤害DEBUFF的时间§8（如迟缓，冰冻，禁魔，缴械）§r和瞬发性控制类DEBUFF的强度§8（如击飞，震退，牵引）§r，不仅包括MC原版的DEBUFF，也包括技能和机制导致的插件原创DEBUFF，每§b1§r点韧性减少§b1§r%持续时间，每§b1§r点韧性减少§b1§r%控制强度""",
                """
                ...
                """
                        §a副武器篇§r：战士副武器的能力是中远距离输出，弥补战士手短的机制弱势，弓箭手副武器的能力是中距离范围输出§8（想要近距离范围输出？不过我没有让弓箭手去贴脸的想法）§r，弥补弓箭手伤害大多趋于单体的弱势，炼丹师的副武器的能力很独特，详情须探索""",
                """
                        §a防具，法宝，饰品篇§r：防具可以带来属性和被动技能，饰品需要放入饰品槽激活，能够带来各种属性增益和被动技能，法宝会给你带来属性和主动技能""",
                """
                        §a异器篇§r：战士异器是盾牌，不再能抵挡箭矢与攻击，而是一个提供属性和被动技能的物品，弓箭手异器是箭袋，炼丹师异器是萃刃，攻击敌人的同时萃取元素
                ...
                """
                        §a职业进阶篇§r：通关职业进阶试炼后即可进阶职业，进阶职业有多个方向，进阶后可以带来一套独特的属性加成，被动技能，甚至可能带来输出机制的改变""",
                """
                ...
                """
                        §a房产系统篇§r：虽然乾坤盒能够提供随身存储空间，且满配乾坤盒可以带来18个大箱子的空间，但对于喜欢囤大量物资的玩家，还是想要更多的空间，房产分为两种类型，简单易得的位于大世界地图外的仓库和位于大世界地图内的高配房产，高配房产除开存储物品，甚至还可能有其它功能""",
                """
