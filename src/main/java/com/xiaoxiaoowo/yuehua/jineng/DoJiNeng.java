...
public final class DoJiNeng {
    ...
    public static void doJiNengProjectile(String id, GongData gongData, Arrow arrow) {
        ...
        switch (id) {
            ...
            case "heiTieNu" -> HeiTieNu.skill1(gongData,multiplier);
            case "hongLinNu" -> HongLinNu.skill1(gongData,multiplier);
            case "jiaoLongNu" -> JiaoLongNu.skill1(gongData,multiplier);
